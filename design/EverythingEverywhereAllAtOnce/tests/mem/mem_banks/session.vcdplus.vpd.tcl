...
# DVE full session
# Saved on Thu Mar 19 14:15:33 2026
# Designs open: 1
#   V1: vcdplus.vpd
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{0 51} {1919 1079}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 192} {height 774} {dock_state left} {dock_on_new_line true} {child_hier_colhier 131} {child_hier_coltype 61} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 895]
catch { set Data.1 [gui_share_window -id ${DLPane.1} -type Data] }
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 895
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 594
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 894} {height 774} {dock_state left} {dock_on_new_line true} {child_data_colvariable 437} {child_data_colvalue 250} {child_data_coltype 197} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{0 51} {1919 1079}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 454} {child_wave_right 1460} {child_wave_colname 226} {child_wave_colvalue 224} {child_wave_col1 0} {child_wave_col2 1}}
...
set _session_group_50 tb_memBanks
gui_sg_create "$_session_group_50"
set tb_memBanks "$_session_group_50"

gui_sg_addsignal -group "$_session_group_50" { {tb_memBanks.$unit} tb_memBanks.bankCmds tb_memBanks.bankOut tb_memBanks.clk tb_memBanks.memBus tb_memBanks.rst }

set _session_group_51 uut0
gui_sg_create "$_session_group_51"
set uut0 "$_session_group_51"

gui_sg_addsignal -group "$_session_group_51" { tb_memBanks.uut0.rst tb_memBanks.uut0.clk tb_memBanks.uut0.controller2bank_i tb_memBanks.uut0.bank_write_data tb_memBanks.uut0.bank_address_i tb_memBanks.uut0.outputs.precharged tb_memBanks.uut0.outputs.clear_writebufV tb_memBanks.uut0.bank_bus tb_memBanks.uut0.fsm_state tb_memBanks.uut0.mem_bank_controller_oe tb_memBanks.uut0.mem_bank_controller_we tb_memBanks.uut0.mem_bank_controller_send_store_address tb_memBanks.uut0.mem_bank_controller_send_store_address_delayed tb_memBanks.uut0.mem_bus }

set _session_group_52 {g_sram_cells[0].mem_cell}
gui_sg_create "$_session_group_52"
set {g_sram_cells[0].mem_cell} "$_session_group_52"

gui_sg_addsignal -group "$_session_group_52" { {tb_memBanks.uut0.g_sram_cells[0].mem_cell.$unit} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.A} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.A_temp} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.CE} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.CE_temp} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.DIO} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.DIO} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.OE} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.WR} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.a_changed} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.addr_unstable_memory} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.din_changed} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.lastread_addr} {tb_memBanks.uut0.g_sram_cells[0].mem_cell.mem} }
...
catch {gui_list_select -id ${Hier.1} {tb_memBanks.uut0}}
...
gui_list_show_data -id ${Data.1} {tb_memBanks.uut0}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {tb_memBanks.uut0.mem_bank_controller_send_store_address_delayed }}
...
gui_open_source -id ${Source.1}  -replace -active tb_memBanks.uut0 /home/ecelrc/students/mak4738/uarch/design_project/design/EverythingEverywhereAllAtOnce/rtl/mem/Mem_Banks/mem_bank.sv
...
gui_wv_zoom_timerange -id ${Wave.1} 1064 1179
...
gui_list_select -id ${Wave.1} {tb_memBanks.uut0.bank_bus }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group uut0  -item tb_memBanks.uut0.mem_bank_controller_send_store_address_delayed -position below

gui_marker_move -id ${Wave.1} {C1} 606
gui_view_scroll -id ${Wave.1} -vertical -set 0
gui_show_grid -id ${Wave.1} -enable false

# DriverLoad 'DriverLoad.1'
gui_get_drivers -session -id ${DriverLoad.1} -signal {tb_memBanks.uut0.g_sram_cells[0].mem_cell.mem[31:0][31:0]} -time 231 -starttime 231
gui_get_loads -session -id ${DriverLoad.1} -signal tb_memBanks.uut0.mem_bank_controller_send_store_address_delayed
...
gui_zoom -window ${Schematic.1} -rect { {-147026 -302954} {272388 71467} }
