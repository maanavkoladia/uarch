...
module tb_stages ();
    ...
    reg [31:0] idm_empty_cycle_counts;
    ...
    always @(posedge clk) begin
        if(!rst) begin
            ...
            if (uut_AllAtOnce.mem_sys_unit.icache_unit.icache_hit == 1) icache_hits <= icache_hits+ 1;
        end
    end
    ...
    //same logic as
    reg [31:0] saved_reg_dump_EIP;
    reg [31:0] saved_flag_dump_EIP;
    reg haltcommited;
    reg [31:0] savedFlags;
