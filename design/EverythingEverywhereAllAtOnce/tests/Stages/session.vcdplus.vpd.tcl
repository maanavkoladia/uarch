...
#<Session mode="Full" path="/home/ecelrc/students/je28497/uarch/design/EverythingEverywhereAllAtOnce/tests/Stages/session.vcdplus.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{3072 877} {4607 1669}}
...
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 523
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 441} {height 514} {dock_state left} {dock_on_new_line true} {child_hier_colhier 335} {child_hier_coltype 107} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_list_add_group -id ${Wave.1} -after core|decode_unit {core|dc_latches_unit}
...
catch {gui_list_select -id ${Hier.1} {tb_stages.uut_core.dc_unit}}
