...
# DVE full session
# Saved on Mon Apr 13 16:55:57 2026
# Designs open: 1
#   V1: vcdplus.vpd
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{131 80} {1469 922}}
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{0 64} {1469 922}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 422} {child_wave_right 1042} {child_wave_colname 338} {child_wave_colvalue 80} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_load_child_values {tb_stages.uut_core.execute_unit.u_mov_op}
gui_load_child_values {tb_stages.uut_core.rr_unit.addygen_logic_unit}
gui_load_child_values {tb_stages.uut_core.execute_unit.u_xchg_op}
gui_load_child_values {tb_stages.uut_core.wb_latches_unit}
gui_load_child_values {tb_stages.uut_core.decode_unit.inst_processing.pfs0}
gui_load_child_values {tb_stages.uut_icache.icache_contrller_fsm}
gui_load_child_values {tb_stages.uut_core.decode_unit.inst_processing.pfs1}
...
gui_load_child_values {tb_stages.uut_core.dc_unit.st_neuralnet_part2}
gui_load_child_values {tb_stages.uut_core.mem_latches_unit}
gui_load_child_values {tb_stages.uut_core.execute_unit.u_pop_op}
...
gui_load_child_values {tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb0}
...
gui_load_child_values {tb_stages.uut_core.execute_unit.u_br_res}
...
gui_sg_move "$_session_group_2599" -after "$_session_group_2594" -pos 3 

set _session_group_2600 Core
gui_sg_create "$_session_group_2600"
set Core "$_session_group_2600"

gui_sg_addsignal -group "$_session_group_2600" { }

set _session_group_2601 $_session_group_2600|
append _session_group_2601 exe_latches_unit
gui_sg_create "$_session_group_2601"
set Core|exe_latches_unit "$_session_group_2601"

gui_sg_addsignal -group "$_session_group_2601" { tb_stages.uut_core.exe_latches_unit.flush tb_stages.uut_core.exe_latches_unit.latches tb_stages.uut_core.exe_latches_unit.latches_o tb_stages.uut_core.exe_latches_unit.farFlush tb_stages.uut_core.exe_latches_unit.nextLatches_i tb_stages.uut_core.exe_latches_unit.clk tb_stages.uut_core.exe_latches_unit.write_enable_i {tb_stages.uut_core.exe_latches_unit.$unit} tb_stages.uut_core.exe_latches_unit.rst }

gui_sg_move "$_session_group_2601" -after "$_session_group_2600" -pos 10 

set _session_group_2602 $_session_group_2600|
append _session_group_2602 mem_unit
gui_sg_create "$_session_group_2602"
set Core|mem_unit "$_session_group_2602"

gui_sg_addsignal -group "$_session_group_2602" { tb_stages.uut_core.mem_unit.hit_buf_v tb_stages.uut_core.mem_unit.line_in_1_masked tb_stages.uut_core.mem_unit.C0 tb_stages.uut_core.mem_unit.hit_buf_mio tb_stages.uut_core.mem_unit.hit_MIO tb_stages.uut_core.mem_unit.low_buf tb_stages.uut_core.mem_unit.line_in_0 tb_stages.uut_core.mem_unit.latches_i tb_stages.uut_core.mem_unit.line_in_1 tb_stages.uut_core.mem_unit.hit_buf_mio_v tb_stages.uut_core.mem_unit.miss_stall tb_stages.uut_core.mem_unit.line_MIO tb_stages.uut_core.mem_unit.cacheline tb_stages.uut_core.mem_unit.line_in_0_masked tb_stages.uut_core.mem_unit.clr_dcache_mio_latch tb_stages.uut_core.mem_unit.exe_latches_next_o tb_stages.uut_core.mem_unit.forward_valid tb_stages.uut_core.mem_unit.exe_stage_next_vaild_o tb_stages.uut_core.mem_unit.hit_buf tb_stages.uut_core.mem_unit.exe_outs_i tb_stages.uut_core.mem_unit.outs_o tb_stages.uut_core.mem_unit.clk tb_stages.uut_core.mem_unit.line_in_mio tb_stages.uut_core.mem_unit.bank_num_0 tb_stages.uut_core.mem_unit.wb_outs_i tb_stages.uut_core.mem_unit.bank_num_1 tb_stages.uut_core.mem_unit.ld_buf tb_stages.uut_core.mem_unit.hit tb_stages.uut_core.mem_unit.up_buf tb_stages.uut_core.mem_unit.exe_stage_we_valid_unit_o {tb_stages.uut_core.mem_unit.$unit} tb_stages.uut_core.mem_unit.clr_dcache_arb_latches tb_stages.uut_core.mem_unit.rst }

gui_sg_move "$_session_group_2602" -after "$_session_group_2600" -pos 9 

set _session_group_2603 $_session_group_2600|
append _session_group_2603 mem_latches_unit
gui_sg_create "$_session_group_2603"
set Core|mem_latches_unit "$_session_group_2603"

gui_sg_addsignal -group "$_session_group_2603" { tb_stages.uut_core.mem_latches_unit.flush tb_stages.uut_core.mem_latches_unit.latches tb_stages.uut_core.mem_latches_unit.latches_o tb_stages.uut_core.mem_latches_unit.farFlush tb_stages.uut_core.mem_latches_unit.nextLatches_i tb_stages.uut_core.mem_latches_unit.clk tb_stages.uut_core.mem_latches_unit.write_enable_i tb_stages.uut_core.mem_latches_unit.rst }

gui_sg_move "$_session_group_2603" -after "$_session_group_2600" -pos 8 

set _session_group_2604 $_session_group_2600|
append _session_group_2604 dc_unit
gui_sg_create "$_session_group_2604"
set Core|dc_unit "$_session_group_2604"

gui_sg_addsignal -group "$_session_group_2604" { tb_stages.uut_core.dc_unit.st_neuralnet_out tb_stages.uut_core.dc_unit.fetch_outs_i tb_stages.uut_core.dc_unit.ld_addr_mio_V tb_stages.uut_core.dc_unit.mem_latches_next_o tb_stages.uut_core.dc_unit.dep_stall tb_stages.uut_core.dc_unit.req_served_0 tb_stages.uut_core.dc_unit.req_served_1 tb_stages.uut_core.dc_unit.mem_ST_OP tb_stages.uut_core.dc_unit.mem_stage_we_valid_unit_o tb_stages.uut_core.dc_unit.data_size_vec tb_stages.uut_core.dc_unit.exp_stall tb_stages.uut_core.dc_unit.ld_addr_mio tb_stages.uut_core.dc_unit.latches_i tb_stages.uut_core.dc_unit.ld_addr_0_V tb_stages.uut_core.dc_unit.stq_stall tb_stages.uut_core.dc_unit.mem_stage_next_vaild_o tb_stages.uut_core.dc_unit.ld_neuralnet_out tb_stages.uut_core.dc_unit.rh_into_mem_o tb_stages.uut_core.dc_unit.ld_addr_1_V tb_stages.uut_core.dc_unit.ld_addr_0 tb_stages.uut_core.dc_unit.dc_ST_OP tb_stages.uut_core.dc_unit.mem_into_rh_o tb_stages.uut_core.dc_unit.ld_addr_1 tb_stages.uut_core.dc_unit.in_flight_stall tb_stages.uut_core.dc_unit.req_served_mio tb_stages.uut_core.dc_unit.exe_outs_i tb_stages.uut_core.dc_unit.arb_stall tb_stages.uut_core.dc_unit.clk tb_stages.uut_core.dc_unit.wb_outs_i tb_stages.uut_core.dc_unit.dc_outs_o tb_stages.uut_core.dc_unit.mem_outs_i tb_stages.uut_core.dc_unit.dc_stall tb_stages.uut_core.dc_unit.exe_ST_OP {tb_stages.uut_core.dc_unit.$unit} tb_stages.uut_core.dc_unit.wb_ST_OP tb_stages.uut_core.dc_unit.rst }

gui_sg_move "$_session_group_2604" -after "$_session_group_2600" -pos 7 

set _session_group_2605 $_session_group_2604|
append _session_group_2605 st_neuralnet_part2
gui_sg_create "$_session_group_2605"
set Core|dc_unit|st_neuralnet_part2 "$_session_group_2605"

gui_sg_addsignal -group "$_session_group_2605" { {tb_stages.uut_core.dc_unit.st_neuralnet_part2.$unit} tb_stages.uut_core.dc_unit.st_neuralnet_part2.vaddy_start tb_stages.uut_core.dc_unit.st_neuralnet_part2.seg_limit_w_datasize tb_stages.uut_core.dc_unit.st_neuralnet_part2.datasize tb_stages.uut_core.dc_unit.st_neuralnet_part2.write_intent tb_stages.uut_core.dc_unit.st_neuralnet_part2.mem_op tb_stages.uut_core.dc_unit.st_neuralnet_part2.rr_gp tb_stages.uut_core.dc_unit.st_neuralnet_part2.next_page_vaddy tb_stages.uut_core.dc_unit.st_neuralnet_part2.vaddy_end tb_stages.uut_core.dc_unit.st_neuralnet_part2.cross_page_access tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb0_pagefault tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb0_generalprotection tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb1_pagefault tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb1_generalprotection tb_stages.uut_core.dc_unit.st_neuralnet_part2.segx_gp tb_stages.uut_core.dc_unit.st_neuralnet_part2.outputs tb_stages.uut_core.dc_unit.st_neuralnet_part2.vaddy_start_fields tb_stages.uut_core.dc_unit.st_neuralnet_part2.vaddy_end_fields tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb0_in tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb1_in tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb0_out tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb1_out }

gui_sg_move "$_session_group_2605" -after "$_session_group_2604" -pos 7 

set _session_group_2606 $_session_group_2605|
append _session_group_2606 tlb0
gui_sg_create "$_session_group_2606"
set Core|dc_unit|st_neuralnet_part2|tlb0 "$_session_group_2606"

gui_sg_addsignal -group "$_session_group_2606" { {tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb0.$unit} tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb0.inputs tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb0.outputs tb_stages.uut_core.dc_unit.st_neuralnet_part2.tlb0.tlb }

gui_sg_move "$_session_group_2606" -after "$_session_group_2605" -pos 7 

set _session_group_2607 $_session_group_2600|
append _session_group_2607 dc_latches_unit
gui_sg_create "$_session_group_2607"
set Core|dc_latches_unit "$_session_group_2607"

gui_sg_addsignal -group "$_session_group_2607" { tb_stages.uut_core.dc_latches_unit.flush tb_stages.uut_core.dc_latches_unit.latches tb_stages.uut_core.dc_latches_unit.latches_o tb_stages.uut_core.dc_latches_unit.farFlush tb_stages.uut_core.dc_latches_unit.nextLatches_i tb_stages.uut_core.dc_latches_unit.clk tb_stages.uut_core.dc_latches_unit.write_enable_i {tb_stages.uut_core.dc_latches_unit.$unit} tb_stages.uut_core.dc_latches_unit.rst }

gui_sg_move "$_session_group_2607" -after "$_session_group_2600" -pos 6 

set _session_group_2608 $_session_group_2600|
append _session_group_2608 rr_unit
gui_sg_create "$_session_group_2608"
set Core|rr_unit "$_session_group_2608"

gui_sg_addsignal -group "$_session_group_2608" { tb_stages.uut_core.rr_unit.fetch_outs_i tb_stages.uut_core.rr_unit.next_ld_vaddy tb_stages.uut_core.rr_unit.cs_sb tb_stages.uut_core.rr_unit.RR_GP tb_stages.uut_core.rr_unit.addygen_input_addy tb_stages.uut_core.rr_unit.ecx_sb tb_stages.uut_core.rr_unit.ld_vaddy tb_stages.uut_core.rr_unit.next_dc_valid tb_stages.uut_core.rr_unit.latches_i tb_stages.uut_core.rr_unit.dc_latches_next tb_stages.uut_core.rr_unit.seg0_limit_w_datasize tb_stages.uut_core.rr_unit.seg1_limit_w_datasize tb_stages.uut_core.rr_unit.latchesInUse tb_stages.uut_core.rr_unit.SEGMENT_LIMITS tb_stages.uut_core.decode_unit.HALT_REG tb_stages.uut_core.decode_unit.HALT_REG tb_stages.uut_core.rr_unit.reg_out tb_stages.uut_core.rr_unit.instructionforward tb_stages.uut_core.rr_unit.rr_stall tb_stages.uut_core.rr_unit.dc_latches_we tb_stages.uut_core.rr_unit.dc_outs_i tb_stages.uut_core.rr_unit.exe_outs_i tb_stages.uut_core.rr_unit.outs_o tb_stages.uut_core.rr_unit.clk tb_stages.uut_core.rr_unit.wb_outs_i tb_stages.uut_core.rr_unit.mem_outs_i tb_stages.uut_core.rr_unit.depstall {tb_stages.uut_core.rr_unit.$unit} tb_stages.uut_core.rr_unit.actual_st_vaddy tb_stages.uut_core.rr_unit.rst tb_stages.uut_core.rr_unit.decode_outs_i tb_stages.uut_core.rr_unit.actual_next_st_vaddy }

gui_sg_move "$_session_group_2608" -after "$_session_group_2600" -pos 5 

set _session_group_2609 $_session_group_2608|
append _session_group_2609 addygen_logic_unit
gui_sg_create "$_session_group_2609"
set Core|rr_unit|addygen_logic_unit "$_session_group_2609"

gui_sg_addsignal -group "$_session_group_2609" { {tb_stages.uut_core.rr_unit.addygen_logic_unit.$unit} tb_stages.uut_core.rr_unit.addygen_logic_unit.register_data tb_stages.uut_core.rr_unit.addygen_logic_unit.regout_sr_data tb_stages.uut_core.rr_unit.addygen_logic_unit.regout_dr_data tb_stages.uut_core.rr_unit.addygen_logic_unit.SIB_IDX_data tb_stages.uut_core.rr_unit.addygen_logic_unit.SIB_BASE_data tb_stages.uut_core.rr_unit.addygen_logic_unit.SIB_SCALE_val tb_stages.uut_core.rr_unit.addygen_logic_unit.sib_needed tb_stages.uut_core.rr_unit.addygen_logic_unit.disp_needed tb_stages.uut_core.rr_unit.addygen_logic_unit.dispsize tb_stages.uut_core.rr_unit.addygen_logic_unit.displacement tb_stages.uut_core.rr_unit.addygen_logic_unit.datasize tb_stages.uut_core.rr_unit.addygen_logic_unit.seg0_data tb_stages.uut_core.rr_unit.addygen_logic_unit.seg1_data tb_stages.uut_core.rr_unit.addygen_logic_unit.seg1_valid tb_stages.uut_core.rr_unit.addygen_logic_unit.modrm_needed tb_stages.uut_core.rr_unit.addygen_logic_unit.rm_is_dr tb_stages.uut_core.rr_unit.addygen_logic_unit.st_sel tb_stages.uut_core.rr_unit.addygen_logic_unit.ld_vaddy tb_stages.uut_core.rr_unit.addygen_logic_unit.seg0_limit_w_datasize tb_stages.uut_core.rr_unit.addygen_logic_unit.next_ld_vaddy tb_stages.uut_core.rr_unit.addygen_logic_unit.actual_st_vaddy tb_stages.uut_core.rr_unit.addygen_logic_unit.seg1_limit_w_datasize tb_stages.uut_core.rr_unit.addygen_logic_unit.actual_next_st_vaddy tb_stages.uut_core.rr_unit.addygen_logic_unit.displacement_out tb_stages.uut_core.rr_unit.addygen_logic_unit.sib_or_reg tb_stages.uut_core.rr_unit.addygen_logic_unit.sib_nonsense tb_stages.uut_core.rr_unit.addygen_logic_unit.shift_result tb_stages.uut_core.rr_unit.addygen_logic_unit.real_seg1_data tb_stages.uut_core.rr_unit.addygen_logic_unit.seg0val_plus_displacement tb_stages.uut_core.rr_unit.addygen_logic_unit.seg1val_plus_displacement tb_stages.uut_core.rr_unit.addygen_logic_unit.st_vaddy tb_stages.uut_core.rr_unit.addygen_logic_unit.shifted_sr_data tb_stages.uut_core.rr_unit.addygen_logic_unit.shifted_dr_data tb_stages.uut_core.rr_unit.addygen_logic_unit.shifted_seg1_data tb_stages.uut_core.rr_unit.addygen_logic_unit.next_ld_VPN tb_stages.uut_core.rr_unit.addygen_logic_unit.next_st_vaddy tb_stages.uut_core.rr_unit.addygen_logic_unit.next_st_VPN tb_stages.uut_core.rr_unit.addygen_logic_unit.next_shifted_sr_data tb_stages.uut_core.rr_unit.addygen_logic_unit.next_shifted_sr_VPN tb_stages.uut_core.rr_unit.addygen_logic_unit.next_shifted_dr_data tb_stages.uut_core.rr_unit.addygen_logic_unit.next_shifted_dr_VPN tb_stages.uut_core.rr_unit.addygen_logic_unit.segment0_limit tb_stages.uut_core.rr_unit.addygen_logic_unit.segment1_limit }

gui_sg_move "$_session_group_2609" -after "$_session_group_2608" -pos 6 

set _session_group_2610 $_session_group_2608|
append _session_group_2610 RegisterFile_unit
gui_sg_create "$_session_group_2610"
set Core|rr_unit|RegisterFile_unit "$_session_group_2610"

gui_sg_addsignal -group "$_session_group_2610" { {tb_stages.uut_core.rr_unit.RegisterFile_unit.$unit} tb_stages.uut_core.rr_unit.RegisterFile_unit.REGISTERS tb_stages.uut_core.rr_unit.RegisterFile_unit.clk tb_stages.uut_core.rr_unit.RegisterFile_unit.rst tb_stages.uut_core.rr_unit.RegisterFile_unit.DR_ID tb_stages.uut_core.rr_unit.RegisterFile_unit.SR_ID tb_stages.uut_core.rr_unit.RegisterFile_unit.SIB_IDX_ID tb_stages.uut_core.rr_unit.RegisterFile_unit.SIB_BASE_ID tb_stages.uut_core.rr_unit.RegisterFile_unit.WB_DR0_data tb_stages.uut_core.rr_unit.RegisterFile_unit.WB_DR1_data tb_stages.uut_core.rr_unit.RegisterFile_unit.WB_DR0_ID tb_stages.uut_core.rr_unit.RegisterFile_unit.WB_DR1_ID tb_stages.uut_core.rr_unit.RegisterFile_unit.WB_DR0_we tb_stages.uut_core.rr_unit.RegisterFile_unit.WB_DR1_we tb_stages.uut_core.rr_unit.RegisterFile_unit.Segment0_ID tb_stages.uut_core.rr_unit.RegisterFile_unit.Segment1_ID tb_stages.uut_core.rr_unit.RegisterFile_unit.outputs }

gui_sg_move "$_session_group_2610" -after "$_session_group_2608" -pos 5 

set _session_group_2611 $_session_group_2608|
append _session_group_2611 reg_sb_unit
gui_sg_create "$_session_group_2611"
set Core|rr_unit|reg_sb_unit "$_session_group_2611"

gui_sg_addsignal -group "$_session_group_2611" { {tb_stages.uut_core.rr_unit.reg_sb_unit.$unit} tb_stages.uut_core.rr_unit.reg_sb_unit.dep_stall tb_stages.uut_core.rr_unit.reg_sb_unit.ecx_sb tb_stages.uut_core.rr_unit.reg_sb_unit.codeSeg_sb tb_stages.uut_core.rr_unit.reg_sb_unit.clk tb_stages.uut_core.rr_unit.reg_sb_unit.rst tb_stages.uut_core.rr_unit.reg_sb_unit.instructionforward tb_stages.uut_core.rr_unit.reg_sb_unit.dr_id tb_stages.uut_core.rr_unit.reg_sb_unit.sr_id tb_stages.uut_core.rr_unit.reg_sb_unit.sib_base_id tb_stages.uut_core.rr_unit.reg_sb_unit.sib_idx_id tb_stages.uut_core.rr_unit.reg_sb_unit.wb_dr0_id tb_stages.uut_core.rr_unit.reg_sb_unit.wb_dr0_we tb_stages.uut_core.rr_unit.reg_sb_unit.wb_dr1_id tb_stages.uut_core.rr_unit.reg_sb_unit.wb_dr1_we tb_stages.uut_core.rr_unit.reg_sb_unit.cs_sib_size tb_stages.uut_core.rr_unit.reg_sb_unit.cs_dr_wr tb_stages.uut_core.rr_unit.reg_sb_unit.cs_sr_wr tb_stages.uut_core.rr_unit.reg_sb_unit.cs_dr_rd tb_stages.uut_core.rr_unit.reg_sb_unit.cs_sr_rd tb_stages.uut_core.rr_unit.reg_sb_unit.Segment0_ID tb_stages.uut_core.rr_unit.reg_sb_unit.Segment1_ID tb_stages.uut_core.rr_unit.reg_sb_unit.Segment1_valid tb_stages.uut_core.rr_unit.reg_sb_unit.flush tb_stages.uut_core.rr_unit.reg_sb_unit.farFlush tb_stages.uut_core.rr_unit.reg_sb_unit.depStall_Internal tb_stages.uut_core.rr_unit.reg_sb_unit.updateSB tb_stages.uut_core.rr_unit.reg_sb_unit.dr_stall tb_stages.uut_core.rr_unit.reg_sb_unit.sr_stall tb_stages.uut_core.rr_unit.reg_sb_unit.seg0_stall tb_stages.uut_core.rr_unit.reg_sb_unit.seg1_stall tb_stages.uut_core.rr_unit.reg_sb_unit.sib_base_stall tb_stages.uut_core.rr_unit.reg_sb_unit.sib_idx_stall tb_stages.uut_core.rr_unit.reg_sb_unit.SCORE_BOARD }

gui_sg_move "$_session_group_2611" -after "$_session_group_2608" -pos 4 

set _session_group_2612 $_session_group_2600|
append _session_group_2612 rr_latches_unit
gui_sg_create "$_session_group_2612"
set Core|rr_latches_unit "$_session_group_2612"

gui_sg_addsignal -group "$_session_group_2612" { tb_stages.uut_core.rr_latches_unit.flush tb_stages.uut_core.rr_latches_unit.latches tb_stages.uut_core.rr_latches_unit.latches_o tb_stages.uut_core.rr_latches_unit.farFlush tb_stages.uut_core.rr_latches_unit.nextLatches_i tb_stages.uut_core.rr_latches_unit.clk tb_stages.uut_core.rr_latches_unit.write_enable_i tb_stages.uut_core.rr_latches_unit.rst }

gui_sg_move "$_session_group_2612" -after "$_session_group_2600" -pos 4 

set _session_group_2613 $_session_group_2600|
append _session_group_2613 decode_unit
gui_sg_create "$_session_group_2613"
set Core|decode_unit "$_session_group_2613"

gui_sg_addsignal -group "$_session_group_2613" { tb_stages.uut_core.decode_unit.REP_LATCH tb_stages.uut_core.decode_unit.clk tb_stages.uut_core.decode_unit.sib_size tb_stages.uut_core.decode_unit.outs_o tb_stages.uut_core.decode_unit.rst tb_stages.uut_core.decode_unit.rr_latches_next tb_stages.uut_core.decode_unit.modrm_byte tb_stages.uut_core.decode_unit.temp_mem_cs tb_stages.uut_core.decode_unit.branch_present tb_stages.uut_core.decode_unit.exe_outs_i tb_stages.uut_core.decode_unit.stall tb_stages.uut_core.decode_unit.next_rr_valid tb_stages.uut_core.decode_unit.invalid_inst tb_stages.uut_core.decode_unit.sibscale tb_stages.uut_core.decode_unit.HALT_REG tb_stages.uut_core.decode_unit.predicted_target tb_stages.uut_core.decode_unit.temp_exe_cs tb_stages.uut_core.decode_unit.temp_decode_cs tb_stages.uut_core.decode_unit.rr_outs_i tb_stages.uut_core.decode_unit.predicted_taken tb_stages.uut_core.decode_unit.inst_length tb_stages.uut_core.decode_unit.PrevEIP tb_stages.uut_core.decode_unit.opcode_byte tb_stages.uut_core.decode_unit.temp_dc_cs tb_stages.uut_core.decode_unit.displacement tb_stages.uut_core.decode_unit.total_pf_vector tb_stages.uut_core.decode_unit.wb_outs_i tb_stages.uut_core.decode_unit.temp_rr_latch tb_stages.uut_core.decode_unit.rep_latch_holder tb_stages.uut_core.decode_unit.sibbase tb_stages.uut_core.decode_unit.segment0 tb_stages.uut_core.decode_unit.NEIP tb_stages.uut_core.decode_unit.temp_wb_cs tb_stages.uut_core.decode_unit.rr_latch_we_o tb_stages.uut_core.decode_unit.sib_byte tb_stages.uut_core.decode_unit.mem_outs_i tb_stages.uut_core.decode_unit.queue tb_stages.uut_core.decode_unit.disp_size tb_stages.uut_core.decode_unit.br_info_for_latches tb_stages.uut_core.decode_unit.EIP tb_stages.uut_core.decode_unit.PrevLength tb_stages.uut_core.decode_unit.fetch_outs_i tb_stages.uut_core.decode_unit.rep_reg_value tb_stages.uut_core.decode_unit.REP_CMP_LATCH tb_stages.uut_core.decode_unit.sibidx tb_stages.uut_core.decode_unit.decode_gp tb_stages.uut_core.decode_unit.idm_outs_i {tb_stages.uut_core.decode_unit.$unit} tb_stages.uut_core.decode_unit.flush tb_stages.uut_core.decode_unit.imm64 tb_stages.uut_core.decode_unit.temp_rr_cs tb_stages.uut_core.decode_unit.dc_outs_i tb_stages.uut_core.decode_unit.disp_needed }

gui_sg_move "$_session_group_2613" -after "$_session_group_2600" -pos 3 

set _session_group_2614 $_session_group_2613|
append _session_group_2614 cs
gui_sg_create "$_session_group_2614"
set Core|decode_unit|cs "$_session_group_2614"

gui_sg_addsignal -group "$_session_group_2614" { {tb_stages.uut_core.decode_unit.cs.$unit} tb_stages.uut_core.decode_unit.cs.total_pf_vector tb_stages.uut_core.decode_unit.cs.opcode tb_stages.uut_core.decode_unit.cs.modrm tb_stages.uut_core.decode_unit.cs.input_bus tb_stages.uut_core.decode_unit.cs.REP_o tb_stages.uut_core.decode_unit.cs.REP_CMP_o tb_stages.uut_core.decode_unit.cs.HALT_o tb_stages.uut_core.decode_unit.cs.MOVS_o tb_stages.uut_core.decode_unit.cs.SHIFT_BY_ONE_o tb_stages.uut_core.decode_unit.cs.MODRM_NEEDED_o tb_stages.uut_core.decode_unit.cs.RM_IS_DR_o tb_stages.uut_core.decode_unit.cs.REG_IS_DR_o tb_stages.uut_core.decode_unit.cs.REG_IS_SEGMENT_o tb_stages.uut_core.decode_unit.cs.HARD_CODED_DR_o tb_stages.uut_core.decode_unit.cs.HARD_CODED_SR_o tb_stages.uut_core.decode_unit.cs.OP_IN_MODRM_o tb_stages.uut_core.decode_unit.cs.HARDCODED_DR_RD_o tb_stages.uut_core.decode_unit.cs.HARDCODED_DR_WR_o tb_stages.uut_core.decode_unit.cs.HARDCODED_SR_RD_o tb_stages.uut_core.decode_unit.cs.HARDCODED_SR_WR_o tb_stages.uut_core.decode_unit.cs.HARDCODED_LD_OP_o tb_stages.uut_core.decode_unit.cs.HARDCODED_ST_OP_o tb_stages.uut_core.decode_unit.cs.ST_SEL_o tb_stages.uut_core.decode_unit.cs.br_uncond_o tb_stages.uut_core.decode_unit.cs.relative_branch_o tb_stages.uut_core.decode_unit.cs.special_br_o tb_stages.uut_core.decode_unit.cs.is_far_o tb_stages.uut_core.decode_unit.cs.second_flag_needed_o tb_stages.uut_core.decode_unit.cs.will_mod_zf_o tb_stages.uut_core.decode_unit.cs.HARDCODED_SEGMENT1_V_o tb_stages.uut_core.decode_unit.cs.HARD_CODED_DR_ID_o tb_stages.uut_core.decode_unit.cs.HARD_CODED_SR_ID_o tb_stages.uut_core.decode_unit.cs.DATA_SIZE_o tb_stages.uut_core.decode_unit.cs.OP_IN_MODRM_SUBSET_o tb_stages.uut_core.decode_unit.cs.alu_inputA_sel_o tb_stages.uut_core.decode_unit.cs.alu_inputB_sel_o tb_stages.uut_core.decode_unit.cs.branch_target_sel_o tb_stages.uut_core.decode_unit.cs.OP_TYPE_o tb_stages.uut_core.decode_unit.cs.HARDCODED_SEGMENT0_o tb_stages.uut_core.decode_unit.cs.HARDCODED_SEGMENT1_o tb_stages.uut_core.decode_unit.cs.decode_cs tb_stages.uut_core.decode_unit.cs.rr_cs tb_stages.uut_core.decode_unit.cs.dc_cs tb_stages.uut_core.decode_unit.cs.mem_cs tb_stages.uut_core.decode_unit.cs.exe_cs tb_stages.uut_core.decode_unit.cs.wb_cs tb_stages.uut_core.decode_unit.cs.temp_decode_cs tb_stages.uut_core.decode_unit.cs.temp_rr_cs tb_stages.uut_core.decode_unit.cs.temp_dc_cs tb_stages.uut_core.decode_unit.cs.temp_mem_cs tb_stages.uut_core.decode_unit.cs.temp_exe_cs tb_stages.uut_core.decode_unit.cs.temp_wb_cs tb_stages.uut_core.decode_unit.cs.mod_rm_cs_outs }

gui_sg_move "$_session_group_2614" -after "$_session_group_2613" -pos 3 

set _session_group_2615 $_session_group_2614|
append _session_group_2615 mod_rm_cs_gen
gui_sg_create "$_session_group_2615"
set Core|decode_unit|cs|mod_rm_cs_gen "$_session_group_2615"

gui_sg_addsignal -group "$_session_group_2615" { {tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.$unit} tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.modrm_byte tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.datasize tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.dr_id tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.sr_id tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.dr_rd tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.sr_rd tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.dr_wr tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.sr_wr tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.ld_op tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.st_op tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.rm_is_dr tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.reg_is_dr tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.reg_is_segment tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.alu_inputA_override tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.alu_inputB_override tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.high8 tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.alu_inputA_override_sel tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.alu_inputB_override_sel tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.decode_cs_inputs tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen.outputs }

gui_sg_move "$_session_group_2615" -after "$_session_group_2614" -pos 3 

set _session_group_2616 $_session_group_2613|
append _session_group_2616 inst_processing
gui_sg_create "$_session_group_2616"
set Core|decode_unit|inst_processing "$_session_group_2616"

gui_sg_addsignal -group "$_session_group_2616" { {tb_stages.uut_core.decode_unit.inst_processing.$unit} tb_stages.uut_core.decode_unit.inst_processing.clk tb_stages.uut_core.decode_unit.inst_processing.rst tb_stages.uut_core.decode_unit.inst_processing.queue tb_stages.uut_core.decode_unit.inst_processing.queue_valid tb_stages.uut_core.decode_unit.inst_processing.EIP tb_stages.uut_core.decode_unit.inst_processing.NEIP tb_stages.uut_core.decode_unit.inst_processing.inst_length tb_stages.uut_core.decode_unit.inst_processing.sib_byte tb_stages.uut_core.decode_unit.inst_processing.sib_size tb_stages.uut_core.decode_unit.inst_processing.opcode_byte tb_stages.uut_core.decode_unit.inst_processing.modrm_byte tb_stages.uut_core.decode_unit.inst_processing.disp tb_stages.uut_core.decode_unit.inst_processing.disp_size tb_stages.uut_core.decode_unit.inst_processing.disp_needed tb_stages.uut_core.decode_unit.inst_processing.imm64 tb_stages.uut_core.decode_unit.inst_processing.total_pf_vector tb_stages.uut_core.decode_unit.inst_processing.invalid_inst tb_stages.uut_core.decode_unit.inst_processing.IR tb_stages.uut_core.decode_unit.inst_processing.IR_valid_vect tb_stages.uut_core.decode_unit.inst_processing.ppu_inst_length tb_stages.uut_core.decode_unit.inst_processing.ppu_imm_size tb_stages.uut_core.decode_unit.inst_processing.ppu_msd_size tb_stages.uut_core.decode_unit.inst_processing.ppu_sib_byte tb_stages.uut_core.decode_unit.inst_processing.ppu_displacement tb_stages.uut_core.decode_unit.inst_processing.ppu_imm tb_stages.uut_core.decode_unit.inst_processing.ppu_needrm tb_stages.uut_core.decode_unit.inst_processing.ppu_disp_size tb_stages.uut_core.decode_unit.inst_processing.ppu_disp_needed tb_stages.uut_core.decode_unit.inst_processing.ppu_sib_size tb_stages.uut_core.decode_unit.inst_processing.num_pfs tb_stages.uut_core.decode_unit.inst_processing.pf_vector0 tb_stages.uut_core.decode_unit.inst_processing.pf_vector1 tb_stages.uut_core.decode_unit.inst_processing.pf_vector2 tb_stages.uut_core.decode_unit.inst_processing.sext_inst_length tb_stages.uut_core.decode_unit.inst_processing.inst_length_cout tb_stages.uut_core.decode_unit.inst_processing.inst_valid tb_stages.uut_core.decode_unit.inst_processing.true_inst_valid tb_stages.uut_core.decode_unit.inst_processing.adder_cout tb_stages.uut_core.decode_unit.inst_processing.possible_eips tb_stages.uut_core.decode_unit.inst_processing.pf0 tb_stages.uut_core.decode_unit.inst_processing.pf1 tb_stages.uut_core.decode_unit.inst_processing.pf2 }

gui_sg_move "$_session_group_2616" -after "$_session_group_2613" -pos 2 

set _session_group_2617 $_session_group_2616|
append _session_group_2617 pfs0
gui_sg_create "$_session_group_2617"
set Core|decode_unit|inst_processing|pfs0 "$_session_group_2617"

gui_sg_addsignal -group "$_session_group_2617" { {tb_stages.uut_core.decode_unit.inst_processing.pfs0.$unit} tb_stages.uut_core.decode_unit.inst_processing.pfs0.opcode_index tb_stages.uut_core.decode_unit.inst_processing.pfs0.modrm_index tb_stages.uut_core.decode_unit.inst_processing.pfs0.IR tb_stages.uut_core.decode_unit.inst_processing.pfs0.IR_valid_vect tb_stages.uut_core.decode_unit.inst_processing.pfs0.total_pf_vector tb_stages.uut_core.decode_unit.inst_processing.pfs0.num_pfs_plusone tb_stages.uut_core.decode_unit.inst_processing.pfs0.inst_length tb_stages.uut_core.decode_unit.inst_processing.pfs0.msd_size tb_stages.uut_core.decode_unit.inst_processing.pfs0.imm_size tb_stages.uut_core.decode_unit.inst_processing.pfs0.disp_size tb_stages.uut_core.decode_unit.inst_processing.pfs0.disp_needed tb_stages.uut_core.decode_unit.inst_processing.pfs0.sib_size tb_stages.uut_core.decode_unit.inst_processing.pfs0.needrm tb_stages.uut_core.decode_unit.inst_processing.pfs0.sib_byte tb_stages.uut_core.decode_unit.inst_processing.pfs0.disp tb_stages.uut_core.decode_unit.inst_processing.pfs0.imm64 tb_stages.uut_core.decode_unit.inst_processing.pfs0.inst_valid tb_stages.uut_core.decode_unit.inst_processing.pfs0.imm_size_fake tb_stages.uut_core.decode_unit.inst_processing.pfs0.msd_size_fake tb_stages.uut_core.decode_unit.inst_processing.pfs0.sib_index tb_stages.uut_core.decode_unit.inst_processing.pfs0.imm_index tb_stages.uut_core.decode_unit.inst_processing.pfs0.op_valid tb_stages.uut_core.decode_unit.inst_processing.pfs0.mod_valid tb_stages.uut_core.decode_unit.inst_processing.pfs0.sib_valid tb_stages.uut_core.decode_unit.inst_processing.pfs0.disp_valid tb_stages.uut_core.decode_unit.inst_processing.pfs0.disp_index tb_stages.uut_core.decode_unit.inst_processing.pfs0.imm_valid tb_stages.uut_core.decode_unit.inst_processing.pfs0.imm_valid_index tb_stages.uut_core.decode_unit.inst_processing.pfs0.imm_size_override }

gui_sg_move "$_session_group_2617" -after "$_session_group_2616" -pos 2 

set _session_group_2618 $_session_group_2616|
append _session_group_2618 pfs1
gui_sg_create "$_session_group_2618"
set Core|decode_unit|inst_processing|pfs1 "$_session_group_2618"

gui_sg_addsignal -group "$_session_group_2618" { {tb_stages.uut_core.decode_unit.inst_processing.pfs1.$unit} tb_stages.uut_core.decode_unit.inst_processing.pfs1.opcode_index tb_stages.uut_core.decode_unit.inst_processing.pfs1.modrm_index tb_stages.uut_core.decode_unit.inst_processing.pfs1.IR tb_stages.uut_core.decode_unit.inst_processing.pfs1.IR_valid_vect tb_stages.uut_core.decode_unit.inst_processing.pfs1.total_pf_vector tb_stages.uut_core.decode_unit.inst_processing.pfs1.num_pfs_plusone tb_stages.uut_core.decode_unit.inst_processing.pfs1.inst_length tb_stages.uut_core.decode_unit.inst_processing.pfs1.msd_size tb_stages.uut_core.decode_unit.inst_processing.pfs1.imm_size tb_stages.uut_core.decode_unit.inst_processing.pfs1.disp_size tb_stages.uut_core.decode_unit.inst_processing.pfs1.disp_needed tb_stages.uut_core.decode_unit.inst_processing.pfs1.sib_size tb_stages.uut_core.decode_unit.inst_processing.pfs1.needrm tb_stages.uut_core.decode_unit.inst_processing.pfs1.sib_byte tb_stages.uut_core.decode_unit.inst_processing.pfs1.disp tb_stages.uut_core.decode_unit.inst_processing.pfs1.imm64 tb_stages.uut_core.decode_unit.inst_processing.pfs1.inst_valid tb_stages.uut_core.decode_unit.inst_processing.pfs1.imm_size_fake tb_stages.uut_core.decode_unit.inst_processing.pfs1.msd_size_fake tb_stages.uut_core.decode_unit.inst_processing.pfs1.sib_index tb_stages.uut_core.decode_unit.inst_processing.pfs1.imm_index tb_stages.uut_core.decode_unit.inst_processing.pfs1.op_valid tb_stages.uut_core.decode_unit.inst_processing.pfs1.mod_valid tb_stages.uut_core.decode_unit.inst_processing.pfs1.sib_valid tb_stages.uut_core.decode_unit.inst_processing.pfs1.disp_valid tb_stages.uut_core.decode_unit.inst_processing.pfs1.disp_index tb_stages.uut_core.decode_unit.inst_processing.pfs1.imm_valid tb_stages.uut_core.decode_unit.inst_processing.pfs1.imm_valid_index tb_stages.uut_core.decode_unit.inst_processing.pfs1.imm_size_override }

gui_sg_move "$_session_group_2618" -after "$_session_group_2616" -pos 1 

set _session_group_2619 $_session_group_2600|
append _session_group_2619 idm_unit
gui_sg_create "$_session_group_2619"
set Core|idm_unit "$_session_group_2619"

gui_sg_addsignal -group "$_session_group_2619" { tb_stages.uut_core.idm_unit.fetch_outs_i tb_stages.uut_core.idm_unit.idm_outs_o tb_stages.uut_core.idm_unit.clk tb_stages.uut_core.idm_unit.idm tb_stages.uut_core.idm_unit.rst }

gui_sg_move "$_session_group_2619" -after "$_session_group_2600" -pos 2 

set _session_group_2620 $_session_group_2600|
append _session_group_2620 fetch_unit
gui_sg_create "$_session_group_2620"
set Core|fetch_unit "$_session_group_2620"

gui_sg_addsignal -group "$_session_group_2620" { tb_stages.uut_core.fetch_unit.spc_sel_logic_outs tb_stages.uut_core.fetch_unit.SPC tb_stages.uut_core.fetch_unit.predictor_inputs tb_stages.uut_core.fetch_unit.seg_xlation_out tb_stages.uut_core.fetch_unit.rr_outs_i tb_stages.uut_core.fetch_unit.idm_ctrl_data_in tb_stages.uut_core.fetch_unit.rom_data_out tb_stages.uut_core.fetch_unit.icache_info_i tb_stages.uut_core.fetch_unit.spc_16 tb_stages.uut_core.fetch_unit.idm_invalidate_logic_outs tb_stages.uut_core.fetch_unit.DMA_int_jk tb_stages.uut_core.fetch_unit.br_target tb_stages.uut_core.fetch_unit.btb_outs tb_stages.uut_core.fetch_unit.predictor_outs tb_stages.uut_core.fetch_unit.dc_outs_i tb_stages.uut_core.fetch_unit.exe_outs_i tb_stages.uut_core.fetch_unit.outs_o tb_stages.uut_core.fetch_unit.clk tb_stages.uut_core.fetch_unit.tlb_inputs tb_stages.uut_core.fetch_unit.wb_outs_i tb_stages.uut_core.fetch_unit.idm_info_i tb_stages.uut_core.fetch_unit.en_icache tb_stages.uut_core.fetch_unit.mem_outs_i tb_stages.uut_core.fetch_unit.f_exp tb_stages.uut_core.fetch_unit.exp_mode_jk tb_stages.uut_core.fetch_unit.br_restore_spc tb_stages.uut_core.fetch_unit.dma_int tb_stages.uut_core.fetch_unit.exp_set_logic_outs tb_stages.uut_core.fetch_unit.int_mode_jk tb_stages.uut_core.fetch_unit.idm_ctrl_logic_outs tb_stages.uut_core.fetch_unit.next_spc tb_stages.uut_core.fetch_unit.spc_2_IDM_CTRL tb_stages.uut_core.fetch_unit.tlb_outs tb_stages.uut_core.fetch_unit.rst tb_stages.uut_core.fetch_unit.decode_outs_i }

gui_sg_move "$_session_group_2620" -after "$_session_group_2600" -pos 1 

set _session_group_2621 $_session_group_2600|
append _session_group_2621 wb_latches_unit
gui_sg_create "$_session_group_2621"
set Core|wb_latches_unit "$_session_group_2621"

gui_sg_addsignal -group "$_session_group_2621" { tb_stages.uut_core.wb_latches_unit.latches tb_stages.uut_core.wb_latches_unit.latches_o tb_stages.uut_core.wb_latches_unit.nextLatches_i tb_stages.uut_core.wb_latches_unit.clk tb_stages.uut_core.wb_latches_unit.write_enable_i {tb_stages.uut_core.wb_latches_unit.$unit} tb_stages.uut_core.wb_latches_unit.rst }

gui_sg_move "$_session_group_2621" -after "$_session_group_2600" -pos 12 

set _session_group_2622 $_session_group_2600|
append _session_group_2622 uut_core
gui_sg_create "$_session_group_2622"
set Core|uut_core "$_session_group_2622"

gui_sg_addsignal -group "$_session_group_2622" { tb_stages.uut_core.mem_latches tb_stages.uut_core.wb_latches_next tb_stages.uut_core.DCacheIn_i tb_stages.uut_core.inFromDMA_i tb_stages.uut_core.dc_outputs tb_stages.uut_core.mem_latches_next tb_stages.uut_core.mem_outputs tb_stages.uut_core.dc_latches_next tb_stages.uut_core.wb_latches tb_stages.uut_core.rr_latches_next tb_stages.uut_core.rr_latches tb_stages.uut_core.exe_latches tb_stages.uut_core.idm_outputs tb_stages.uut_core.fetch_outputs tb_stages.uut_core.clk tb_stages.uut_core.wb_outputs tb_stages.uut_core.decode_outputs tb_stages.uut_core.rr_outputs tb_stages.uut_core.exe_latches_next tb_stages.uut_core.out2DCache_o tb_stages.uut_core.exe_outputs {tb_stages.uut_core.$unit} tb_stages.uut_core.ICacheIn_i tb_stages.uut_core.dc_latches tb_stages.uut_core.out2ICache_o tb_stages.uut_core.rst }

set _session_group_2623 $_session_group_2600|
append _session_group_2623 write_back_unit
gui_sg_create "$_session_group_2623"
set Core|write_back_unit "$_session_group_2623"

gui_sg_addsignal -group "$_session_group_2623" { tb_stages.uut_core.write_back_unit.write_success tb_stages.uut_core.write_back_unit.reg_wb_logic_outs tb_stages.uut_core.write_back_unit.stq_info tb_stages.uut_core.write_back_unit.mio_q_output tb_stages.uut_core.write_back_unit.write_success_mio tb_stages.uut_core.write_back_unit.stq_heads tb_stages.uut_core.write_back_unit.wb_latches tb_stages.uut_core.write_back_unit.outputs tb_stages.uut_core.write_back_unit.mio_q_input tb_stages.uut_core.write_back_unit.stq_outputs tb_stages.uut_core.write_back_unit.dc_dep tb_stages.uut_core.write_back_unit.clk tb_stages.uut_core.write_back_unit.stall_flop_next tb_stages.uut_core.write_back_unit.stall_flop {tb_stages.uut_core.write_back_unit.$unit} tb_stages.uut_core.write_back_unit.rst }

gui_sg_move "$_session_group_2623" -after "$_session_group_2600" -pos 13 

set _session_group_2624 $_session_group_2600|
append _session_group_2624 execute_unit
gui_sg_create "$_session_group_2624"
set Core|execute_unit "$_session_group_2624"

gui_sg_addsignal -group "$_session_group_2624" { tb_stages.uut_core.execute_unit.latches_i tb_stages.uut_core.execute_unit.latches_i.EIP tb_stages.uut_core.execute_unit.sar_cf_o tb_stages.uut_core.execute_unit.cmp_pf_o tb_stages.uut_core.execute_unit.not_dr_o tb_stages.uut_core.execute_unit.iretd_stack_ptr_o tb_stages.uut_core.execute_unit.sbb_res_buf_o tb_stages.uut_core.execute_unit.st_op_next tb_stages.uut_core.execute_unit.and_of_o tb_stages.uut_core.execute_unit.outs_o tb_stages.uut_core.execute_unit.packssdw_dr_o tb_stages.uut_core.execute_unit.data_size tb_stages.uut_core.execute_unit.bsf_dr_o tb_stages.uut_core.execute_unit.add_cf_o tb_stages.uut_core.execute_unit.rst tb_stages.uut_core.execute_unit.cmp_sf_o tb_stages.uut_core.execute_unit.xchg_sr_o tb_stages.uut_core.execute_unit.paddd_dr_o tb_stages.uut_core.execute_unit.dr_next tb_stages.uut_core.execute_unit.flags_reg tb_stages.uut_core.execute_unit.call_res_buf tb_stages.uut_core.execute_unit.iretd_cf_o tb_stages.uut_core.execute_unit.sar_dr_o tb_stages.uut_core.execute_unit.sr_next tb_stages.uut_core.execute_unit.ret_far_imm_dr_o tb_stages.uut_core.execute_unit.and_res_buf_o tb_stages.uut_core.execute_unit.br_sel tb_stages.uut_core.execute_unit.adc_pf_o tb_stages.uut_core.execute_unit.cmpxchg_sr_o tb_stages.uut_core.execute_unit.pop_dr_o tb_stages.uut_core.execute_unit.bsf_zf_o tb_stages.uut_core.execute_unit.add_dr_o tb_stages.uut_core.execute_unit.adc_res_buf_o tb_stages.uut_core.execute_unit.sbb_pf_o tb_stages.uut_core.execute_unit.wb_latches_next_o tb_stages.uut_core.execute_unit.bit_vec_1_next tb_stages.uut_core.execute_unit.clk tb_stages.uut_core.execute_unit.ret_far_cs_o tb_stages.uut_core.execute_unit.adc_sf_o tb_stages.uut_core.execute_unit.not_res_buf_o tb_stages.uut_core.execute_unit.sar_zf_o tb_stages.uut_core.execute_unit.sal_pf_o tb_stages.uut_core.execute_unit.or_pf_o tb_stages.uut_core.execute_unit.sbb_sf_o tb_stages.uut_core.execute_unit.ret_imm_sr_o tb_stages.uut_core.execute_unit.add_zf_o tb_stages.uut_core.execute_unit.sar_of_o tb_stages.uut_core.execute_unit.sal_sf_o tb_stages.uut_core.execute_unit.or_sf_o tb_stages.uut_core.execute_unit.cancel_dr_we tb_stages.uut_core.execute_unit.cmpxchg_pf_o tb_stages.uut_core.execute_unit.push_res_buf tb_stages.uut_core.execute_unit.of_flag_o tb_stages.uut_core.execute_unit.iretd_zf_o tb_stages.uut_core.execute_unit.add_af_o tb_stages.uut_core.execute_unit.aaa_cf_o tb_stages.uut_core.execute_unit.bsf_res_buf_o tb_stages.uut_core.execute_unit.add_of_o tb_stages.uut_core.execute_unit.cmp_cf_o tb_stages.uut_core.execute_unit.push_sr_o tb_stages.uut_core.execute_unit.xchg_res_buf tb_stages.uut_core.execute_unit.mov_res_buf_o tb_stages.uut_core.execute_unit.wb_stage_next_vaild_o tb_stages.uut_core.execute_unit.iretd_af_o tb_stages.uut_core.execute_unit.cmpxchg_sf_o tb_stages.uut_core.execute_unit.far_call_res_buf tb_stages.uut_core.execute_unit.iretd_of_o tb_stages.uut_core.execute_unit.and_pf_o tb_stages.uut_core.execute_unit.ret_far_next_ptr_o tb_stages.uut_core.execute_unit.cf_flag_o tb_stages.uut_core.execute_unit.wb_dr_next tb_stages.uut_core.execute_unit.mov_dr_o tb_stages.uut_core.execute_unit.wb_stage_we_valid_unit_o tb_stages.uut_core.execute_unit.wb_sr_next tb_stages.uut_core.execute_unit.wb_outs_i tb_stages.uut_core.execute_unit.sal_res_buf_o tb_stages.uut_core.execute_unit.aaa_dr_o tb_stages.uut_core.execute_unit.branch_resolution_o tb_stages.uut_core.execute_unit.and_sf_o tb_stages.uut_core.execute_unit.ret_far_imm_sr_o tb_stages.uut_core.execute_unit.adc_cf_o tb_stages.uut_core.execute_unit.far_call_dr_o tb_stages.uut_core.execute_unit.pop_sr_o tb_stages.uut_core.execute_unit.sbb_cf_o tb_stages.uut_core.execute_unit.cancel_sr_we tb_stages.uut_core.execute_unit.ret_sr_o tb_stages.uut_core.execute_unit.sal_cf_o tb_stages.uut_core.execute_unit.or_cf_o tb_stages.uut_core.execute_unit.cmp_zf_o tb_stages.uut_core.execute_unit.adc_dr_o tb_stages.uut_core.execute_unit.sar_res_buf_o tb_stages.uut_core.execute_unit.sf_flag_o tb_stages.uut_core.execute_unit.aaa_af_o }
gui_sg_addsignal -group "$_session_group_2624" { tb_stages.uut_core.execute_unit.bit_vec_0_next tb_stages.uut_core.execute_unit.cmp_af_o tb_stages.uut_core.execute_unit.sar_pf_o tb_stages.uut_core.execute_unit.cmp_of_o tb_stages.uut_core.execute_unit.pf_flag_o tb_stages.uut_core.execute_unit.sbb_dr_o tb_stages.uut_core.execute_unit.op_type tb_stages.uut_core.execute_unit.cmpxchg_cf_o tb_stages.uut_core.execute_unit.sal_dr_o tb_stages.uut_core.execute_unit.or_dr_o tb_stages.uut_core.execute_unit.add_pf_o tb_stages.uut_core.execute_unit.adc_zf_o tb_stages.uut_core.execute_unit.sar_sf_o tb_stages.uut_core.execute_unit.xchg_dr_o tb_stages.uut_core.execute_unit.df_flag_o tb_stages.uut_core.execute_unit.clr_ZF_sb tb_stages.uut_core.execute_unit.iretd_pf_o tb_stages.uut_core.execute_unit.or_res_buf_o tb_stages.uut_core.execute_unit.af_flag_o tb_stages.uut_core.execute_unit.sbb_zf_o tb_stages.uut_core.execute_unit.adc_af_o tb_stages.uut_core.execute_unit.packsswb_dr_o tb_stages.uut_core.execute_unit.cmpxchg_dr_o tb_stages.uut_core.execute_unit.add_sf_o tb_stages.uut_core.execute_unit.adc_of_o tb_stages.uut_core.execute_unit.cmpxchg_buf_o tb_stages.uut_core.execute_unit.srA tb_stages.uut_core.execute_unit.srB tb_stages.uut_core.execute_unit.cancel_store tb_stages.uut_core.execute_unit.sal_zf_o tb_stages.uut_core.execute_unit.or_zf_o tb_stages.uut_core.execute_unit.iretd_sf_o tb_stages.uut_core.execute_unit.sbb_af_o tb_stages.uut_core.execute_unit.iretd_cs_o tb_stages.uut_core.execute_unit.sbb_of_o tb_stages.uut_core.execute_unit.and_dr_o tb_stages.uut_core.execute_unit.res_buf_next tb_stages.uut_core.execute_unit.sal_of_o tb_stages.uut_core.execute_unit.or_of_o tb_stages.uut_core.execute_unit.pavgw_dr_o tb_stages.uut_core.execute_unit.add_res_buf_o tb_stages.uut_core.execute_unit.cmpxchg_zf_o {tb_stages.uut_core.execute_unit.$unit} tb_stages.uut_core.execute_unit.pavgb_dr_o tb_stages.uut_core.execute_unit.paddw_dr_o tb_stages.uut_core.execute_unit.zf_flag_o tb_stages.uut_core.execute_unit.res_buf_selected tb_stages.uut_core.execute_unit.call_dr_o tb_stages.uut_core.execute_unit.cmpxchg_af_o tb_stages.uut_core.execute_unit.cmpxchg_of_o tb_stages.uut_core.execute_unit.and_zf_o tb_stages.uut_core.execute_unit.latches_i }

gui_sg_move "$_session_group_2624" -after "$_session_group_2600" -pos 11 

set _session_group_2625 $_session_group_2624|
append _session_group_2625 u_mov_op
gui_sg_create "$_session_group_2625"
set Core|execute_unit|u_mov_op "$_session_group_2625"

gui_sg_addsignal -group "$_session_group_2625" { {tb_stages.uut_core.execute_unit.u_mov_op.$unit} tb_stages.uut_core.execute_unit.u_mov_op.srA tb_stages.uut_core.execute_unit.u_mov_op.srB tb_stages.uut_core.execute_unit.u_mov_op.data_size tb_stages.uut_core.execute_unit.u_mov_op.res_buf_o tb_stages.uut_core.execute_unit.u_mov_op.dr_o tb_stages.uut_core.execute_unit.u_mov_op.merged_res }

gui_sg_move "$_session_group_2625" -after "$_session_group_2624" -pos 17 

set _session_group_2626 $_session_group_2624|
append _session_group_2626 u_br_res
gui_sg_create "$_session_group_2626"
set Core|execute_unit|u_br_res "$_session_group_2626"

gui_sg_addsignal -group "$_session_group_2626" { {tb_stages.uut_core.execute_unit.u_br_res.$unit} tb_stages.uut_core.execute_unit.u_br_res.valid_i tb_stages.uut_core.execute_unit.u_br_res.br_eip_i tb_stages.uut_core.execute_unit.u_br_res.br_xcl_i tb_stages.uut_core.execute_unit.u_br_res.br_pred_taken_i tb_stages.uut_core.execute_unit.u_br_res.speculative_target_i tb_stages.uut_core.execute_unit.u_br_res.br_ucond_i tb_stages.uut_core.execute_unit.u_br_res.relative_branch_i tb_stages.uut_core.execute_unit.u_br_res.special_br_i tb_stages.uut_core.execute_unit.u_br_res.is_far_i tb_stages.uut_core.execute_unit.u_br_res.second_flag_needed_i tb_stages.uut_core.execute_unit.u_br_res.br_source_i tb_stages.uut_core.execute_unit.u_br_res.NEIP_i tb_stages.uut_core.execute_unit.u_br_res.CF tb_stages.uut_core.execute_unit.u_br_res.ZF tb_stages.uut_core.execute_unit.u_br_res.br_target tb_stages.uut_core.execute_unit.u_br_res.taken tb_stages.uut_core.execute_unit.u_br_res.clr_exp_mode tb_stages.uut_core.execute_unit.u_br_res.flush tb_stages.uut_core.execute_unit.u_br_res.far_flush tb_stages.uut_core.execute_unit.u_br_res.miss_prediction tb_stages.uut_core.execute_unit.u_br_res.second_flag_result tb_stages.uut_core.execute_unit.u_br_res.cond_br_res tb_stages.uut_core.execute_unit.u_br_res.target_match tb_stages.uut_core.execute_unit.u_br_res.outs_o }

gui_sg_move "$_session_group_2626" -after "$_session_group_2624" -pos 16 

set _session_group_2627 $_session_group_2624|
append _session_group_2627 u_pop_op
gui_sg_create "$_session_group_2627"
set Core|execute_unit|u_pop_op "$_session_group_2627"

gui_sg_addsignal -group "$_session_group_2627" { {tb_stages.uut_core.execute_unit.u_pop_op.$unit} tb_stages.uut_core.execute_unit.u_pop_op.value_i tb_stages.uut_core.execute_unit.u_pop_op.sp_i tb_stages.uut_core.execute_unit.u_pop_op.dr_o tb_stages.uut_core.execute_unit.u_pop_op.sr_o }

gui_sg_move "$_session_group_2627" -after "$_session_group_2624" -pos 15 

set _session_group_2628 $_session_group_2624|
append _session_group_2628 u_xchg_op
gui_sg_create "$_session_group_2628"
set Core|execute_unit|u_xchg_op "$_session_group_2628"

gui_sg_addsignal -group "$_session_group_2628" { tb_stages.uut_core.execute_unit.u_xchg_op.srA tb_stages.uut_core.execute_unit.u_xchg_op.srB tb_stages.uut_core.execute_unit.u_xchg_op.dr_o tb_stages.uut_core.execute_unit.u_xchg_op.new_r32_val tb_stages.uut_core.execute_unit.u_xchg_op.res_buf tb_stages.uut_core.execute_unit.u_xchg_op.sr_o tb_stages.uut_core.execute_unit.u_xchg_op.data_size {tb_stages.uut_core.execute_unit.u_xchg_op.$unit} tb_stages.uut_core.execute_unit.u_xchg_op.new_eax_rm_val }

gui_sg_move "$_session_group_2628" -after "$_session_group_2624" -pos 2 

set _session_group_2629 Group1
gui_sg_create "$_session_group_2629"
set Group1 "$_session_group_2629"

gui_sg_addsignal -group "$_session_group_2629" { tb_stages.uut_core.decode_unit.HALT_REG tb_stages.uut_core.decode_unit.HALT_REG }
...
catch {gui_list_expand -id ${Hier.1} tb_stages.uut_core.decode_unit.cs}
catch {gui_list_select -id ${Hier.1} {tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen}}
gui_view_scroll -id ${Hier.1} -vertical -set 208
gui_view_scroll -id ${Hier.1} -horizontal -set 0

# Data 'Data.1'
gui_list_set_filter -id ${Data.1} -list { {Buffer 1} {Input 1} {Others 1} {Linkage 1} {Output 1} {LowPower 1} {Parameter 1} {All 1} {Aggregate 1} {LibBaseMember 1} {Event 1} {Assertion 1} {Constant 1} {Interface 1} {BaseMembers 1} {Signal 1} {$unit 1} {Inout 1} {Variable 1} }
gui_list_set_filter -id ${Data.1} -text {*latches_i}
gui_list_show_data -id ${Data.1} {tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen}
...
gui_list_show_data -id ${Data.2} {tb_stages.uut_core.decode_unit.cs.mod_rm_cs_gen}
...
gui_marker_create -id ${Wave.1} M1 692
gui_marker_set_ref -id ${Wave.1}  C1
gui_wv_zoom_timerange -id ${Wave.1} 0 1977.745
...
gui_list_add_group -id ${Wave.1} -after tb_stages.uut_core.decode_unit.clk {Core|decode_unit|inst_processing}
gui_list_add_group -id ${Wave.1} -after {{tb_stages.uut_core.decode_unit.inst_processing.$unit}} {Core|decode_unit|inst_processing|pfs1}
gui_list_add_group -id ${Wave.1} -after Core|decode_unit|inst_processing|pfs1 {Core|decode_unit|inst_processing|pfs0}
gui_list_add_group -id ${Wave.1} -after Core|decode_unit|inst_processing {Core|decode_unit|cs}
gui_list_add_group -id ${Wave.1} -after {{tb_stages.uut_core.decode_unit.cs.opcode[7:0]}} {Core|decode_unit|cs|mod_rm_cs_gen}
...
gui_list_add_group -id ${Wave.1} -after Core|rr_unit|RegisterFile_unit {Core|rr_unit|addygen_logic_unit}
...
gui_list_add_group -id ${Wave.1} -after tb_stages.uut_core.dc_unit.req_served_1 {Core|dc_unit|st_neuralnet_part2}
gui_list_add_group -id ${Wave.1} -after tb_stages.uut_core.dc_unit.st_neuralnet_part2.rr_gp {Core|dc_unit|st_neuralnet_part2|tlb0}
...
gui_list_add_group -id ${Wave.1} -after {{tb_stages.uut_core.execute_unit.latches_i.EIP[31:0]}} {Core|execute_unit|u_xchg_op}
gui_list_add_group -id ${Wave.1} -after tb_stages.uut_core.execute_unit.add_cf_o {Core|execute_unit|u_pop_op}
gui_list_add_group -id ${Wave.1} -after Core|execute_unit|u_pop_op {Core|execute_unit|u_br_res}
gui_list_add_group -id ${Wave.1} -after Core|execute_unit|u_br_res {Core|execute_unit|u_mov_op}
...
gui_list_collapse -id ${Wave.1} Core|execute_unit|u_pop_op
gui_list_collapse -id ${Wave.1} Core|execute_unit|u_br_res
gui_list_collapse -id ${Wave.1} Core|execute_unit|u_mov_op
gui_list_collapse -id ${Wave.1} Core|wb_latches_unit
gui_list_expand -id ${Wave.1} tb_stages.uut_core.dc_unit.latches_i
gui_list_expand -id ${Wave.1} tb_stages.uut_core.dc_unit.latches_i.cs
gui_list_expand -id ${Wave.1} tb_stages.uut_core.execute_unit.latches_i
gui_list_expand -id ${Wave.1} tb_stages.uut_core.execute_unit.latches_i.cs
gui_list_expand -id ${Wave.1} tb_stages.uut_core.write_back_unit.stq_outputs
gui_list_expand -id ${Wave.1} {tb_stages.uut_core.write_back_unit.stq_outputs[0]}
gui_set_radix -radix enum_toggle -signal tb_stages.uut_core.dc_unit.latches_i.sr_id
gui_set_radix -radix enum_toggle -signal tb_stages.uut_core.dc_unit.latches_i.dr_id
gui_set_radix -radix enum_toggle -signal tb_stages.uut_core.execute_unit.latches_i.cs.OP_TYPE
gui_set_radix -radix enum_toggle -signal tb_stages.uut_core.execute_unit.latches_i.cs.alu_inputA_sel
gui_set_radix -radix enum_toggle -signal tb_stages.uut_core.execute_unit.latches_i.cs.alu_inputB_sel
gui_set_radix -radix enum_toggle -signal tb_stages.uut_core.execute_unit.latches_i.cs.branch_target_sel
gui_set_radix -radix enum_toggle -signal tb_stages.uut_core.execute_unit.latches_i.ld_buf
gui_set_radix -radix enum_toggle -signal tb_stages.uut_core.execute_unit.latches_i.sr_id
gui_set_radix -radix enum_toggle -signal tb_stages.uut_core.execute_unit.latches_i.dr_id
gui_set_radix -radix enum_toggle -signal {{tb_stages.uut_core.write_back_unit.stq_outputs[0].valid}}
gui_set_radix -radix enum_toggle -signal {{tb_stages.uut_core.write_back_unit.stq_outputs[0].address}}
gui_set_radix -radix enum_toggle -signal {{tb_stages.uut_core.write_back_unit.stq_outputs[0].data}}
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Core|decode_unit|cs  -position in

gui_marker_move -id ${Wave.1} {C1} 642.477
