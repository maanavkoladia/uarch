...
# DVE full session
# Saved on Sun Apr 12 04:22:42 2026
# Designs open: 1
#   V1: vcdplus.vpd
...
#   Group diskWrapper_Unit signal count = 12
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 330} {height 267} {dock_state left} {dock_on_new_line true} {child_hier_colhier 232} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 233} {height 267} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 238} {child_wave_right 1036} {child_wave_colname 145} {child_wave_colvalue 89} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_load_child_values {tb_dma.uut_dma.diskWrapper_Unit}
...
gui_sg_move "$_session_group_202" -after "$_session_group_201" -pos 1 

set _session_group_203 $_session_group_201|
append _session_group_203 controller
gui_sg_create "$_session_group_203"
set u_mainMem|controller "$_session_group_203"

gui_sg_addsignal -group "$_session_group_203" { {tb_dma.u_mainMem.controller.$unit} tb_dma.u_mainMem.controller.clk tb_dma.u_mainMem.controller.rst tb_dma.u_mainMem.controller.address_bus tb_dma.u_mainMem.controller.data_bus tb_dma.u_mainMem.controller.mem_controller_state_bits tb_dma.u_mainMem.controller.fsm_state tb_dma.u_mainMem.controller.hit_into_fsm tb_dma.u_mainMem.controller.chipNum tb_dma.u_mainMem.controller.bankBits_InChip tb_dma.u_mainMem.controller.rowBitFromChipAddress tb_dma.u_mainMem.controller.bank_num_for_chip tb_dma.u_mainMem.controller.bankGroup tb_dma.u_mainMem.controller.DTE_i tb_dma.u_mainMem.controller.ToDTE_o tb_dma.u_mainMem.controller.ToScheduler_o tb_dma.u_mainMem.controller.bank_cmds_o tb_dma.u_mainMem.controller.banks_i tb_dma.u_mainMem.controller.bankGroupTable tb_dma.u_mainMem.controller.chipTable tb_dma.u_mainMem.controller.fsm_outs }

set _session_group_204 diskWrapper_Unit
gui_sg_create "$_session_group_204"
set diskWrapper_Unit "$_session_group_204"

gui_sg_addsignal -group "$_session_group_204" { tb_dma.uut_dma.diskWrapper_Unit.ld_diskAddr tb_dma.uut_dma.diskWrapper_Unit.disk tb_dma.uut_dma.diskWrapper_Unit.loading tb_dma.uut_dma.diskWrapper_Unit.ld_write_buf_req tb_dma.uut_dma.diskWrapper_Unit.ld_num_bytes tb_dma.uut_dma.diskWrapper_Unit.disk_ld_Buffer_o tb_dma.uut_dma.diskWrapper_Unit.clk tb_dma.uut_dma.diskWrapper_Unit.disk_ld_Buffer_V tb_dma.uut_dma.diskWrapper_Unit.disk_ld_Buffer {tb_dma.uut_dma.diskWrapper_Unit.$unit} tb_dma.uut_dma.diskWrapper_Unit.delayCycles_Counter tb_dma.uut_dma.diskWrapper_Unit.rst }
...
catch {gui_list_expand -id ${Hier.1} tb_dma.uut_dma}
catch {gui_list_select -id ${Hier.1} {tb_dma.uut_dma.diskWrapper_Unit}}
...
gui_list_show_data -id ${Data.1} {tb_dma.uut_dma.diskWrapper_Unit}
...
gui_marker_create -id ${Wave.1} M1 1140.97
gui_marker_create -id ${Wave.1} M2 1405.17
gui_marker_create -id ${Wave.1} M3 1652.97
gui_marker_select -id ${Wave.1} {  M1 }
gui_marker_set_ref -id ${Wave.1}  C1
gui_wv_zoom_timerange -id ${Wave.1} 17566.911 17660.785
...
gui_list_collapse -id ${Wave.1} u_mainMem
...
gui_list_expand -id ${Wave.1} tb_dma.u_dcache.out2Core_o
gui_list_expand -id ${Wave.1} tb_dma.u_dcache.out2Core_o.hit
gui_list_expand -id ${Wave.1} tb_dma.u_dcache.out2Core_o.cacheline
gui_list_expand -id ${Wave.1} {tb_dma.u_dcache.out2Core_o.cacheline[3]}
...
gui_list_set_insertion_bar  -id ${Wave.1} -group diskWrapper_Unit  -position in

gui_marker_move -id ${Wave.1} {C1} 17580
gui_view_scroll -id ${Wave.1} -vertical -set 599
