...
# DVE full session
# Saved on Sat Apr 11 17:24:28 2026
# Designs open: 1
#   V1: vcdplus.vpd
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{0 51} {1407 791}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 333} {height 540} {dock_state left} {dock_on_new_line true} {child_hier_colhier 232} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 236} {height 540} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1407} {height 105} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{0 51} {1407 791}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 311} {child_wave_right 1091} {child_wave_colname 164} {child_wave_colvalue 143} {child_wave_col1 0} {child_wave_col2 1}}
...
set _session_group_112 uut0_dcache
gui_sg_create "$_session_group_112"
set uut0_dcache "$_session_group_112"

gui_sg_addsignal -group "$_session_group_112" { {tb_dcache.uut0_dcache.$unit} tb_dcache.uut0_dcache.clk tb_dcache.uut0_dcache.rst tb_dcache.uut0_dcache.dataBus tb_dcache.uut0_dcache.address_bus tb_dcache.uut0_dcache.hitVec tb_dcache.uut0_dcache.arb_st_override_Out tb_dcache.uut0_dcache.arb_req_served_0_out tb_dcache.uut0_dcache.arb_req_served_1_out tb_dcache.uut0_dcache.inFromCore_i tb_dcache.uut0_dcache.out2Core_o tb_dcache.uut0_dcache.inFromDTE_i tb_dcache.uut0_dcache.out2Sch_o tb_dcache.uut0_dcache.blockOutputs tb_dcache.uut0_dcache.req_2_blocks tb_dcache.uut0_dcache.mio_block_outputs }

set _session_group_113 dcache_arbitration
gui_sg_create "$_session_group_113"
set dcache_arbitration "$_session_group_113"

gui_sg_addsignal -group "$_session_group_113" { {tb_dcache.uut0_dcache.dcache_arbitration.$unit} tb_dcache.uut0_dcache.dcache_arbitration.clk_i tb_dcache.uut0_dcache.dcache_arbitration.rst tb_dcache.uut0_dcache.dcache_arbitration.block_hit_i tb_dcache.uut0_dcache.dcache_arbitration.reqServed_0_o tb_dcache.uut0_dcache.dcache_arbitration.reqServed_1_o tb_dcache.uut0_dcache.dcache_arbitration.st_override_o tb_dcache.uut0_dcache.dcache_arbitration.writeSuccess_o tb_dcache.uut0_dcache.dcache_arbitration.block_idleness tb_dcache.uut0_dcache.dcache_arbitration.memStage_CLR_REQ tb_dcache.uut0_dcache.dcache_arbitration.readyForNewReq tb_dcache.uut0_dcache.dcache_arbitration.ld_req_0_bankNum tb_dcache.uut0_dcache.dcache_arbitration.ld_req_1_bankNum tb_dcache.uut0_dcache.dcache_arbitration.st_override tb_dcache.uut0_dcache.dcache_arbitration.ldReq_2_BankPresent tb_dcache.uut0_dcache.dcache_arbitration.LD_REQ_BANK_UB tb_dcache.uut0_dcache.dcache_arbitration.LD_REQ_BANK_LB tb_dcache.uut0_dcache.dcache_arbitration.LD_REQ_BANK_WIDTH tb_dcache.uut0_dcache.dcache_arbitration.core_i tb_dcache.uut0_dcache.dcache_arbitration.reqs_2_blocks_o tb_dcache.uut0_dcache.dcache_arbitration.reqs tb_dcache.uut0_dcache.dcache_arbitration.nextReqs }
...
gui_wv_zoom_timerange -id ${Wave.1} 2463571 2644116
...
gui_list_expand -id ${Wave.1} {tb_dcache.uut0_dcache.g_dcache_block[0].block.block_req_i}
gui_list_expand -id ${Wave.1} {tb_dcache.uut0_dcache.g_dcache_block[0].block.outputs_o}
gui_list_expand -id ${Wave.1} {tb_dcache.uut0_dcache.g_dcache_block[0].block.eb_outputs}
gui_list_select -id ${Wave.1} {{tb_dcache.uut0_dcache.g_dcache_block[0].block.block_req_i.p_addr} }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group {g_dcache_block[0].block}  -item {tb_dcache.uut0_dcache.g_dcache_block[0].block.clk_i} -position below

gui_marker_move -id ${Wave.1} {C1} 2553759
gui_view_scroll -id ${Wave.1} -vertical -set 600
