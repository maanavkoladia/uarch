module ICache_TagStore (
    ...
    logic [ICACHE_INDEX_WIDTH - 1 : 0] v_addr_i_tag = v_addr_i[ICACHE_TAG_UB : ICACHE_TAG_LB];
    //logic [ICACHE_INDEX_WIDTH - 1 : 0] swapBuf_p_addr_i_index = I_VC_SwapBuf_i.lineAddr[ICACHE_INDEX_UB : ICACHE_INDEX_LB];

    bool validStore[NUM_ICACHE_LINES];

    //comes from paddr_i or vswap addr, but bc of timing, well use the v_addr
    //in always, it will always be correct
    ...
    assign DIN_2_TagStore = v_addr_i_tag;
