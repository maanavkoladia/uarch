...
wire NS_0_n2;
`NAND_3(NS_0_nand2, 1, NS_0_n2, S_1, S_2_inv, ld_buf_data_V_i)

`NAND_3(NS_0_nand, 1, NS_0, NS_0_n0, NS_0_n1, NS_0_n2)

// NS_1 = (S_1 & !S_2 & !ld_buf_data_V_i & writeBuf_V_i) | (!S_1 & !S_2 & start_write_i & !write_Complete_i) | (S_0 & !S_1 & !S_2 & !write_Complete_i) | (!S_0 & !S_1 & !S_2 & start_write_i) | (!S_0 & S_1 & !S_2 & !ld_buf_data_V_i) | (S_0 & S_1 & !S_2 & writeBuf_V_i)
wire NS_1_t0;
...
wire NS_1_t5;
`AND_4(NS_1_and5, 1, NS_1_t5, S_0, S_1, S_2_inv, writeBuf_V_i)
