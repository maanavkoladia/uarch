...
// NS_1 = (!S_1 & !S_2 & start_write_i & !write_Complete_i) | (!S_0 & S_1 & !S_2 & !ld_buf_data_V_i) | (S_0 & S_1 & !S_2 & writeBuf_V_i) | (!S_0 & !S_1 & !S_2 & start_write_i) | (S_0 & !S_1 & !S_2 & !write_Complete_i)
=======
`OR_3(NS_0_or, 1, NS_0, NS_0_t0, NS_0_t1, NS_0_t2)

// NS_1 = (S_0 & S_1 & !S_2 & writeBuf_V_i) | (!S_0 & S_1 & !S_2 & !ld_buf_data_V_i) | (!S_0 & !S_1 & !S_2 & start_write_i) | (S_0 & !S_1 & !S_2 & !write_Complete_i)
>>>>>>> s_comp
wire NS_1_t0;
`AND_4(NS_1_and0, 1, NS_1_t0, S_0, S_1, S_2_inv, writeBuf_V_i)
wire NS_1_t1;
`AND_4(NS_1_and1, 1, NS_1_t1, S_0_inv, S_1, S_2_inv, ld_buf_data_V_i_inv)
wire NS_1_t2;
...
and4$ NS_1_and1 (NS_1_t1, S_0_inv, S_1, S_2_inv, ld_buf_data_V_i_inv);
