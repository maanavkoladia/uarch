...
// NS_1 = (!S_0 & S_1 & !S_2 & !ld_buf_data_V_i) | (!S_1 & !S_2 & start_write_i & !write_Complete_i) | (S_0 & S_1 & !S_2 & writeBuf_V_i) | (S_0 & !S_1 & !S_2 & !write_Complete_i) | (!S_0 & !S_1 & !S_2 & start_write_i)
wire NS_1_t0;
