...
// NS_1 = (!S_0 & S_1 & !S_2 & !ld_buf_data_V_i) | (!S_0 & !S_1 & !S_2 & start_write_i) | (S_0 & !S_2 & !write_Complete_i & writeBuf_V_i) | (S_0 & S_1 & !S_2 & writeBuf_V_i) | (S_0 & !S_1 & !S_2 & !write_Complete_i)
wire NS_1_t0;
`AND_4(NS_1_and0, 1, NS_1_t0, S_0_inv, S_1, S_2_inv, ld_buf_data_V_i_inv)
wire NS_1_t1;
`AND_4(NS_1_and1, 1, NS_1_t1, S_0_inv, S_1_inv, S_2_inv, start_write_i)
wire NS_1_t2;
`AND_4(NS_1_and2, 1, NS_1_t2, S_0, S_2_inv, write_Complete_i_inv, writeBuf_V_i)
wire NS_1_t3;
