...
// NS_1 = (S_0 & S_1 & !S_2 & writeBuf_V_i) | (!S_0 & S_1 & !S_2 & !ld_buf_data_V_i) | (!S_1 & !S_2 & start_write_i & !write_Complete_i) | (S_0 & !S_1 & !S_2 & !write_Complete_i) | (!S_0 & !S_1 & !S_2 & start_write_i)
wire NS_1_t0;
wire NS_1_t1;
wire NS_1_t2;
wire NS_1_t3;
...
and4$ NS_1_and0 (NS_1_t0, S_0, S_1, S_2_inv, writeBuf_V_i);
and4$ NS_1_and1 (NS_1_t1, S_0_inv, S_1, S_2_inv, ld_buf_data_V_i_inv);
and4$ NS_1_and2 (NS_1_t2, S_1_inv, S_2_inv, start_write_i, write_Complete_i_inv);
...
// busy_o = (S_0 & !S_2) | (S_1 & !S_2) | (!S_2 & start_write_i)
wire busy_o_t0;
wire busy_o_t1;
wire busy_o_t2;
