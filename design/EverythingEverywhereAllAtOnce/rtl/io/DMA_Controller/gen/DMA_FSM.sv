...
// NS_1 = (S_0 & !S_2 & !write_Complete_i & writeBuf_V_i) | (!S_0 & !S_2 & start_write_i & !ld_buf_data_V_i) | (!S_0 & !S_1 & !S_2 & start_write_i) | (!S_0 & S_1 & !S_2 & !ld_buf_data_V_i) | (S_0 & S_1 & !S_2 & writeBuf_V_i) | (S_0 & !S_1 & !S_2 & !write_Complete_i)
wire NS_1_t0;
`AND_4(NS_1_and0, 1, NS_1_t0, S_0, S_2_inv, write_Complete_i_inv, writeBuf_V_i)
wire NS_1_t1;
