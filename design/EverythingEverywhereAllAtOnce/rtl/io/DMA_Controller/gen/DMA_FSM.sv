...
// NS_1 = (S_0 & !S_2 & !write_Complete_i & writeBuf_V_i) | (!S_0 & S_1 & !S_2 & !ld_buf_data_V_i) | (!S_0 & !S_1 & !S_2 & start_write_i) | (S_0 & !S_1 & !S_2 & !write_Complete_i) | (S_0 & S_1 & !S_2 & writeBuf_V_i)
wire NS_1_t0;
wire NS_1_t1;
wire NS_1_t2;
wire NS_1_t3;
