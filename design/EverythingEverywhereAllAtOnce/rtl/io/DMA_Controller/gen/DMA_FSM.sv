...
wire NS_0_n0;
`NAND_3(NS_0_nand0, 1, NS_0_n0, S_1, S_2_inv, ld_buf_data_V_i)
wire NS_0_n1;
`NAND_3(NS_0_nand1, 1, NS_0_n1, S_0, S_2_inv, write_Complete_i_inv)
wire NS_0_n2;
`NAND_3(NS_0_nand2, 1, NS_0_n2, S_0, S_1, S_2_inv)

`NAND_3(NS_0_nand, 1, NS_0, NS_0_n0, NS_0_n1, NS_0_n2)

// NS_1 = (S_0 & S_1 & !S_2 & writeBuf_V_i) | (S_0 & !S_1 & !S_2 & !write_Complete_i) | (!S_0 & !S_1 & !S_2 & start_write_i) | (!S_0 & S_1 & !S_2 & !ld_buf_data_V_i)
wire NS_1_n0;
`NAND_4(NS_1_nand0, 1, NS_1_n0, S_0, S_1, S_2_inv, writeBuf_V_i)
wire NS_1_n1;
`NAND_4(NS_1_nand1, 1, NS_1_n1, S_0, S_1_inv, S_2_inv, write_Complete_i_inv)
wire NS_1_n2;
`NAND_4(NS_1_nand2, 1, NS_1_n2, S_0_inv, S_1_inv, S_2_inv, start_write_i)
wire NS_1_n3;
`NAND_4(NS_1_nand3, 1, NS_1_n3, S_0_inv, S_1, S_2_inv, ld_buf_data_V_i_inv)

`NAND_4(NS_1_nand, 1, NS_1, NS_1_n0, NS_1_n1, NS_1_n2, NS_1_n3)
