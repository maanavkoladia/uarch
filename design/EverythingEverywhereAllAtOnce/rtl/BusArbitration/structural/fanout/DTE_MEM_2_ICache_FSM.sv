...
//  - mem_valid_o re-driven through bufferH16$ (fanout 8 external),
//    +0.24 ns on mem_valid_o.
// ======================================================================
...
wire NS_0_n0;
`NAND_3(NS_0_nand0, 1, NS_0_n0, S_0_inv, S_1_a, S_2_inv)
wire NS_0_n1;
`NAND_3(NS_0_nand1, 1, NS_0_n1, S_0_a, S_1_inv, S_2_a)
wire NS_0_n2;
...
wire NS_2_t0;
`AND_3(NS_2_and0, 1, NS_2_t0, S_0_a, S_1_a, S_2_inv)
wire NS_2_t1;
`AND_3(NS_2_and1, 1, NS_2_t1, S_0_inv, S_1_a, S_2_a)
wire NS_2_t2;
...
wire busy_o_n0;
`NAND_2(busy_o_nand0, 1, busy_o_n0, S_0_b, S_1_inv)
wire busy_o_n1;
`NAND_2(busy_o_nand1, 1, busy_o_n1, S_1_b, S_2_inv)
wire busy_o_n2;
`NAND_2(busy_o_nand2, 1, busy_o_n2, S_1_inv, S_2_b)
...
`NAND_2(Drive_Addr_Bus_o_nand0, 1, Drive_Addr_Bus_o_n0, S_0_b, S_1_inv)
wire Drive_Addr_Bus_o_n1;
`NAND_2(Drive_Addr_Bus_o_nand1, 1, Drive_Addr_Bus_o_n1, S_1_b, S_2_inv)
wire Drive_Addr_Bus_o_n2;
`NAND_2(Drive_Addr_Bus_o_nand2, 1, Drive_Addr_Bus_o_n2, S_1_inv, S_2_c)
