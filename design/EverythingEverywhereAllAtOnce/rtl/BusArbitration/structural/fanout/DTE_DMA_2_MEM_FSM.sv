...
//  - Drv_DB_0/1/2/3_o re-driven through bufferH64$ (each fanout 33 external),
//    +0.30 ns per output. Output port re-buffered; original AND_3 output
//    renamed to *_pre.
// ======================================================================
...
wire NS_1_n0;
`NAND_3(NS_1_nand0, 1, NS_1_n0, S_0_a, S_1_inv, S_2_inv)
wire NS_1_n1;
`NAND_3(NS_1_nand1, 1, NS_1_n1, S_0_inv, S_1_a, S_2_inv)
...
wire busy_o_n0;
`NAND_2(busy_o_nand0, 1, busy_o_n0, S_0_a, S_2_inv)
wire busy_o_n1;
`NAND_2(busy_o_nand1, 1, busy_o_n1, S_1_a, S_2_inv)
wire busy_o_n2;
...
`AND_3(WriteComplete_o_and, 1, WriteComplete_o, S_0_b, S_1_b, S_2_inv)

// Commiting_o = (!S_0 & !S_1 & S_2)
`AND_3(Commiting_o_and, 1, Commiting_o, S_0_inv, S_1_inv, S_2_b)
...
// Drv_DB_0_o = (!S_0 & !S_1 & S_2)  -- buffered (fanout 33 external)
wire Drv_DB_0_o_pre;
`AND_3(Drv_DB_0_o_and, 1, Drv_DB_0_o_pre, S_0_inv, S_1_inv, S_2_c)
bufferH64$ u_Drv_DB_0_o_buf (.out(Drv_DB_0_o), .in(Drv_DB_0_o_pre));

// Drv_DB_1_o = (S_0 & !S_1 & !S_2)  -- buffered (fanout 33 external)
wire Drv_DB_1_o_pre;
`AND_3(Drv_DB_1_o_and, 1, Drv_DB_1_o_pre, S_0_b, S_1_inv, S_2_inv)
bufferH64$ u_Drv_DB_1_o_buf (.out(Drv_DB_1_o), .in(Drv_DB_1_o_pre));

// Drv_DB_2_o = (!S_0 & S_1 & !S_2)  -- buffered (fanout 33 external)
wire Drv_DB_2_o_pre;
`AND_3(Drv_DB_2_o_and, 1, Drv_DB_2_o_pre, S_0_inv, S_1_b, S_2_inv)
bufferH64$ u_Drv_DB_2_o_buf (.out(Drv_DB_2_o), .in(Drv_DB_2_o_pre));

// Drv_DB_3_o = (S_0 & S_1 & !S_2)  -- buffered (fanout 33 external)
wire Drv_DB_3_o_pre;
`AND_3(Drv_DB_3_o_and, 1, Drv_DB_3_o_pre, S_0_c, S_1_c, S_2_inv)
bufferH64$ u_Drv_DB_3_o_buf (.out(Drv_DB_3_o), .in(Drv_DB_3_o_pre));
