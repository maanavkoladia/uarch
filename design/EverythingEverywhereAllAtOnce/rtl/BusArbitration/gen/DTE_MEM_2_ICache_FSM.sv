...
wire NS_0_n0;
`NAND_3(NS_0_nand0, 1, NS_0_n0, S_0, S_1_inv, S_2)
wire NS_0_n1;
...
// Drive_Addr_Bus_o = (!S_1 & S_2) | (S_1 & !S_2) | (S_0 & !S_2) | (!S_2 & req_hit_i & !others_busy_i)
...
`NAND_2(Drive_Addr_Bus_o_nand2, 1, Drive_Addr_Bus_o_n2, S_0, S_2_inv)
