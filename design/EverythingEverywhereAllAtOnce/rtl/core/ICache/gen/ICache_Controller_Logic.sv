...
// ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
//       S_0       S_1       S_2  hit_or_miss_i  mem_valid_i  |      NS_0      NS_1      NS_2  mem_request_o   fill0_o   fill1_o   fill2_o   fill3_o
// ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
// fill0_o = (!S_0 & !mem_valid_i) | (!S_0 & S_1) | (S_0 & !S_1 & !S_2) | (!S_0 & S_2)
wire fill0_o_t0;
wire fill0_o_t1;
wire fill0_o_t2;
wire fill0_o_t3;
...
and2$ fill0_o_and1 (fill0_o_t1, S_0_inv, S_1);
and3$ fill0_o_and2 (fill0_o_t2, S_0, S_1_inv, S_2_inv);
and2$ fill0_o_and3 (fill0_o_t3, S_0_inv, S_2);
...
//  fill2_o = (!S_0 & S_2) | (!S_1 & !S_2) | (!S_0 & !mem_valid_i)
wire  fill2_o_t0;
wire  fill2_o_t1;
wire  fill2_o_t2;

and2$  fill2_o_and0 ( fill2_o_t0, S_0_inv, S_2);
...
//  fill3_o = (!S_1 & !S_2) | (!S_0 & !mem_valid_i) | (!S_0 & !S_2) | (!S_0 & !S_1)
wire  fill3_o_t0;
wire  fill3_o_t1;
wire  fill3_o_t2;
wire  fill3_o_t3;

and2$  fill3_o_and0 ( fill3_o_t0, S_1_inv, S_2_inv);
and2$  fill3_o_and1 ( fill3_o_t1, S_0_inv, mem_valid_i_inv);
