module EveryThing_TOP (
    ...
    input wire DCache_i_hit_0,
    input wire DCache_i_hit_1,
    input wire DCache_i_hit_2,
    input wire DCache_i_hit_3,

    input wire [127:0] DCache_i_cacheline_0,
    input wire [127:0] DCache_i_cacheline_1,
    input wire [127:0] DCache_i_cacheline_2,
    input wire [127:0] DCache_i_cacheline_3,

    input wire DCache_i_writeSuccess_0,
    input wire DCache_i_writeSuccess_1,
    input wire DCache_i_writeSuccess_2,
    input wire DCache_i_writeSuccess_3,

    input    wire DCache_i_writeSuccess_MIO,  //for pop MIO
    input    wire DCache_i_hit_MIO,  //for ld_mem stage
    input    wire DCache_i_reqServed_MIO,  //for dc stage
    input    wire [127:0] DCache_i_line_MIO,
    ...
    generate
        for (
            gi_exe_ldbuf_next = 0;
            gi_exe_ldbuf_next < EXE_BUFFER_SIZE;
            gi_exe_ldbuf_next = gi_exe_ldbuf_next + 1
        ) begin : g_pack_exe_ld_buf_next
    ...
    generate
        for (
            gi_dcache_h = 0; gi_dcache_h < CACHE_LINES_SIZE_B; gi_dcache_h = gi_dcache_h + 1
        ) begin : g_unpack_dcache_stq
    ...
    assign dc_latches_next.exe_cs.branch_target_sel = {
        27'b0, dc_latches_next_exe_cs_branch_target_sel_w
    };
    ...
    assign rr_latches_next.normal_latches.exe_cs.OP_TYPE = {
        26'b0, rr_latches_next_normal_latches_exe_cs_OP_TYPE_w
    };
    assign rr_latches_next.normal_latches.exe_cs.alu_inputA_sel = {
        27'b0, rr_latches_next_normal_latches_exe_cs_alu_inputA_sel_w
    };
    assign rr_latches_next.normal_latches.exe_cs.alu_inputB_sel = {
        27'b0, rr_latches_next_normal_latches_exe_cs_alu_inputB_sel_w
    };
    assign rr_latches_next.normal_latches.exe_cs.branch_target_sel = {
        27'b0, rr_latches_next_normal_latches_exe_cs_branch_target_sel_w
    };

    assign rr_latches_next.rep_latches.exe_cs.OP_TYPE = {
        26'b0, rr_latches_next_rep_latches_exe_cs_OP_TYPE_w
    };
    assign rr_latches_next.rep_latches.exe_cs.alu_inputA_sel = {
        27'b0, rr_latches_next_rep_latches_exe_cs_alu_inputA_sel_w
    };
    assign rr_latches_next.rep_latches.exe_cs.alu_inputB_sel = {
        27'b0, rr_latches_next_rep_latches_exe_cs_alu_inputB_sel_w
    };
    assign rr_latches_next.rep_latches.exe_cs.branch_target_sel = {
        27'b0, rr_latches_next_rep_latches_exe_cs_branch_target_sel_w
    };
    ...
    generate
        for (
            gi_idm_data = 0; gi_idm_data < CACHE_LINES_SIZE_B; gi_idm_data = gi_idm_data + 1
        ) begin : g_unpack_idm_data
    ...
    generate
        for (
            gi_idm_req_data = 0;
            gi_idm_req_data < CACHE_LINES_SIZE_B;
            gi_idm_req_data = gi_idm_req_data + 1
        ) begin : g_unpack_idm_req_data
    ...
    DC dc_unit (
        ...
        .latches_cs_LD_OP(),
        .latches_cs_ST_OP(),
        .latches_cs_dr_upper8(),
        .latches_cs_sr_upper8(),
        .latches_cs_datasize(),
        .latches_mem_cs_ST_OP(),
        .latches_mem_cs_LD_OP(),
        .latches_exe_cs_ST_OP(),
        .latches_exe_cs_OP_TYPE(),
        .latches_exe_cs_alu_inputA_sel(),
        .latches_exe_cs_alu_inputB_sel(),
        .latches_exe_cs_branch_target_sel(),
        .latches_exe_cs_shift_by_one(),
        .latches_exe_cs_br_ucond(),
        .latches_exe_cs_relative_branch(),
        .latches_exe_cs_special_br(),
        .latches_exe_cs_is_far(),
        .latches_exe_cs_is_call(),
        .latches_exe_cs_second_flag_needed(),
        .latches_exe_cs_rep_no_zf_update(),
        .latches_wb_cs_ST_OP(),
        .latches_wb_cs_WB_DR(),
        .latches_wb_cs_WB_SR(),
        .latches_wb_cs_WB_EAX(),
        .latches_br_info_valid(),
        .latches_br_info_br_eip(),
        .latches_br_info_br_xcl(),
        .latches_br_info_br_pred_taken(),
        .latches_br_info_speculative_target(),
        .latches_rr_gp(),
        .latches_ld_vaddy(),
        .latches_seg0_limit_w_datasize(),
        .latches_seg0_limit_wo_datasize(),
        .latches_next_ld_vaddy(),
        .latches_ld_laddy(),
        .latches_ld_stack_access(),
        .latches_st_vaddy(),
        .latches_seg1_limit_w_datasize(),
        .latches_seg1_limit_wo_datasize(),
        .latches_next_st_vaddy(),
        .latches_st_laddy(),
        .latches_st_stack_access(),
        .latches_NEIP(),
        .latches_EIP(),
        .latches_EAX(),
        .latches_imm64(),
        ...
        .wb_outs_ST_PADDR_0(),
        .wb_outs_ST_PADDR_1(),
        .wb_outs_dep_check_entry_0_valid(),
        .wb_outs_dep_check_entry_0_address(),
        .wb_outs_dep_check_entry_1_valid(),
        .wb_outs_dep_check_entry_1_address(),
        .wb_outs_dep_check_entry_2_valid(),
        .wb_outs_dep_check_entry_2_address(),
        .wb_outs_dep_check_entry_3_valid(),
        .wb_outs_dep_check_entry_3_address(),
        .wb_outs_dep_check_entry_4_valid(),
        .wb_outs_dep_check_entry_4_address(),
        .wb_outs_dep_check_entry_5_valid(),
        .wb_outs_dep_check_entry_5_address(),
        .wb_outs_dep_check_entry_6_valid(),
        .wb_outs_dep_check_entry_6_address(),
        .wb_outs_dep_check_entry_7_valid(),
        .wb_outs_dep_check_entry_7_address(),
        .wb_outs_dep_check_entry_8_valid(),
        .wb_outs_dep_check_entry_8_address(),
        .wb_outs_dep_check_entry_9_valid(),
        .wb_outs_dep_check_entry_9_address(),
        .wb_outs_dep_check_entry_10_valid(),
        .wb_outs_dep_check_entry_10_address(),
        .wb_outs_dep_check_entry_11_valid(),
        .wb_outs_dep_check_entry_11_address(),
        .wb_outs_dep_check_entry_12_valid(),
        .wb_outs_dep_check_entry_12_address(),
        .wb_outs_dep_check_entry_13_valid(),
        .wb_outs_dep_check_entry_13_address(),
        .wb_outs_dep_check_entry_14_valid(),
        .wb_outs_dep_check_entry_14_address(),
        .wb_outs_dep_check_entry_15_valid(),
        .wb_outs_dep_check_entry_15_address(),
        .req_served_mio(),
        .req_served_0(),
        .req_served_1(),
        .mem_latches_next_valid(),
        .mem_latches_next_cs_ST_OP(),
        .mem_latches_next_cs_LD_OP(),
        .mem_latches_next_exe_cs_ST_OP(),
        .mem_latches_next_exe_cs_OP_TYPE(),
        .mem_latches_next_exe_cs_alu_inputA_sel(),
        .mem_latches_next_exe_cs_alu_inputB_sel(),
        .mem_latches_next_exe_cs_branch_target_sel(),
        .mem_latches_next_exe_cs_shift_by_one(),
        .mem_latches_next_exe_cs_br_ucond(),
        .mem_latches_next_exe_cs_relative_branch(),
        .mem_latches_next_exe_cs_special_br(),
        .mem_latches_next_exe_cs_is_far(),
        .mem_latches_next_exe_cs_is_call(),
        .mem_latches_next_exe_cs_second_flag_needed(),
        .mem_latches_next_exe_cs_rep_no_zf_update(),
        .mem_latches_next_wb_cs_ST_OP(),
        .mem_latches_next_wb_cs_WB_DR(),
        .mem_latches_next_wb_cs_WB_SR(),
        .mem_latches_next_wb_cs_WB_EAX(),
        .mem_latches_next_br_info_valid(),
        .mem_latches_next_br_info_br_eip(),
        .mem_latches_next_br_info_br_xcl(),
        .mem_latches_next_br_info_br_pred_taken(),
        .mem_latches_next_br_info_speculative_target(),
        .mem_latches_next_data_size_vec(),
        .mem_latches_next_sr_data_size_vec(),
        .mem_latches_next_shift_sr_up(),
        .mem_latches_next_shift_sr_down(),
        .mem_latches_next_ST_XCL(),
        .mem_latches_next_ST_PADDR_0(),
        .mem_latches_next_ST_PADDR_1(),
        .mem_latches_next_MIO(),
        .mem_latches_next_NEIP(),
        .mem_latches_next_EIP(),
        .mem_latches_next_EAX(),
        .mem_latches_next_imm64(),
        .mem_latches_next_sr_id(),
        .mem_latches_next_sr_data(),
        .mem_latches_next_dr_id(),
        .mem_latches_next_dr_data(),
        .mem_latches_next_LD_XCL(),
        .mem_latches_next_swapLines(),
        .mem_latches_next_LD_PADDR_0(),
        .mem_latches_next_LD_PADDR_1(),
        .dc_outs_valid(),
        .dc_outs_dc_eip(),
        .dc_outs_stall(),
        .dc_outs_exp_pf(),
        ...
        .dc_outs_ld_addr_1_V(),
        .dc_outs_ld_addr_1(),
        .dc_outs_ld_addr_MIO_V(),
        .dc_outs_ld_addr_MIO(),
        .dc_outs_mem_stage_latch_we()
    );
    ...
    MEM mem_unit (
        ...
        .hit_0(DCache_i_hit_0),
        .hit_1(DCache_i_hit_1),
        .hit_2(DCache_i_hit_2),
        .hit_3(DCache_i_hit_3),

        .cacheline_0(DCache_i_cacheline_0),
        .cacheline_1(DCache_i_cacheline_1),
        .cacheline_2(DCache_i_cacheline_2),
        .cacheline_3(DCache_i_cacheline_3),

        .hit_MIO (DCache_i_hit_MIO),
        .line_MIO(DCache_i_line_MIO),
