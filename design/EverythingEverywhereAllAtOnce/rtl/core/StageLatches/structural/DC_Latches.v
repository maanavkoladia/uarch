...
module DC_Latches (
    ...
    `MUX_2(u_dc_mux_exe_cs_OP_TYPE,                 6,   exe_cs_OP_TYPE_d,                 nextLatches_exe_cs_OP_TYPE_i,                 6'b0,    combined_flush);
    `MUX_2(u_dc_mux_exe_cs_alu_inputA_sel,          5,   exe_cs_alu_inputA_sel_d,          nextLatches_exe_cs_alu_inputA_sel_i,          5'b0,    combined_flush);
    `MUX_2(u_dc_mux_exe_cs_alu_inputB_sel,          5,   exe_cs_alu_inputB_sel_d,          nextLatches_exe_cs_alu_inputB_sel_i,          5'b0,    combined_flush);
    `MUX_2(u_dc_mux_exe_cs_branch_target_sel,       5,   exe_cs_branch_target_sel_d,       nextLatches_exe_cs_branch_target_sel_i,       5'b0,    combined_flush);
    ...
    `REG_RST_WE(dc_latches_exe_cs_OP_TYPE,                 6,   clk, rst, effective_we, exe_cs_OP_TYPE_d,                 latches_exe_cs_OP_TYPE_o);
