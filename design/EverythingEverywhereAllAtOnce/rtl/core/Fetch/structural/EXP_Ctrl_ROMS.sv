...
module EXP_Ctrl_ROMS (
    ...
    // 16 bytes of ROM data, LSB-first packing: byte i is rom_data_out[i*8 +: 8].
    // Was an unpacked-array port in the SV original; flattened to a packed
    // 128-bit bus so this file compiles in pure Verilog 2005.
