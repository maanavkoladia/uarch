...
module RR (
    ...
    npu_node1 addygen_logic_unit (
        ...
        .segment0_limit_data(SEGMENT_LIMITS[latchesInUse.cs.seg_0_id].limit),
        .seg1_data(reg_out.Segment1_data),
        .segment1_limit_data(SEGMENT_LIMITS[latchesInUse.cs.seg_1_id].limit),
    ...
    RegSB reg_sb_unit (
        ...
        .dr_id         (latchesInUse.cs.dr_id[`REG_ID_W-1:0]),
        .sr_id         (latchesInUse.cs.sr_id[`REG_ID_W-1:0]),
        .flush         (exe_outs_i.br_res_out.flush),
        .farFlush      (exe_outs_i.br_res_out.farFlush),
        .callFlush     (exe_outs_i.br_res_out.callFlush),
        .sib_base_id   (latchesInUse.sib_base_id[`REG_ID_W-1:0]),
        .sib_idx_id    (latchesInUse.sib_idx_id[`REG_ID_W-1:0]),
        .wb_dr0_id     (exe_outs_i.DR_0_id[`REG_ID_W-1:0]),
        .wb_dr0_we     (exe_outs_i.DR_0_we),
        .wb_dr1_id     (exe_outs_i.DR_1_id[`REG_ID_W-1:0]),
        .wb_dr1_we     (exe_outs_i.DR_1_we),
        ...
        .Segment0_ID   (latchesInUse.cs.seg_0_id[`REG_ID_W-1:0]),
        .Segment1_ID   (latchesInUse.cs.seg_1_id[`REG_ID_W-1:0]),
