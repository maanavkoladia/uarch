module RegFile (
    ...
    // ----- CS  (ID 0) -----
    // Three register copies, same we/din:
    //   _a -> DR/SR/SIB_IDX read muxes only
    //   _b -> SIB_BASE/Seg0/Seg1 muxes + CS_data alias
    //   _c -> REG_CS_o port (wide forward bus to EXE)
    ...
    wire [63:0] REG_CS_a_o, REG_CS_b_o, REG_CS_c_o;
    wire [63:0] REG_CS_b_o_pre_buf;
    ...
    wire [63:0] REG_DS_a_o, REG_DS_b_o, REG_DS_c_o;
    `REG_RST_WE(REG_DS_a, 64, clk, rst, we_DS, din_DS, REG_DS_a_o)
    `REG_RST_WE(REG_DS_b, 64, clk, rst, we_DS, din_DS, REG_DS_b_o)
    `REG_RST_WE(REG_DS_c, 64, clk, rst, we_DS, din_DS, REG_DS_c_o)
    assign REG_DS_o = REG_DS_c_o;
    ...
    wire [63:0] REG_SS_a_o, REG_SS_b_o, REG_SS_c_o;
    `REG_RST_WE(REG_SS_a, 64, clk, rst, we_SS, din_SS, REG_SS_a_o)
    `REG_RST_WE(REG_SS_b, 64, clk, rst, we_SS, din_SS, REG_SS_b_o)
    `REG_RST_WE(REG_SS_c, 64, clk, rst, we_SS, din_SS, REG_SS_c_o)
    assign REG_SS_o = REG_SS_c_o;
    ...
    wire [63:0] REG_ES_a_o, REG_ES_b_o, REG_ES_c_o;
    `REG_RST_WE(REG_ES_a, 64, clk, rst, we_ES, din_ES, REG_ES_a_o)
    `REG_RST_WE(REG_ES_b, 64, clk, rst, we_ES, din_ES, REG_ES_b_o)
    `REG_RST_WE(REG_ES_c, 64, clk, rst, we_ES, din_ES, REG_ES_c_o)
    assign REG_ES_o = REG_ES_c_o;
    ...
    wire [63:0] REG_FS_a_o, REG_FS_b_o, REG_FS_c_o;
    `REG_RST_WE(REG_FS_a, 64, clk, rst, we_FS, din_FS, REG_FS_a_o)
    `REG_RST_WE(REG_FS_b, 64, clk, rst, we_FS, din_FS, REG_FS_b_o)
    `REG_RST_WE(REG_FS_c, 64, clk, rst, we_FS, din_FS, REG_FS_c_o)
    assign REG_FS_o = REG_FS_c_o;
    ...
    wire [63:0] REG_GS_a_o, REG_GS_b_o, REG_GS_c_o;
    `REG_RST_WE(REG_GS_a, 64, clk, rst, we_GS, din_GS, REG_GS_a_o)
    `REG_RST_WE(REG_GS_b, 64, clk, rst, we_GS, din_GS, REG_GS_b_o)
    `REG_RST_WE(REG_GS_c, 64, clk, rst, we_GS, din_GS, REG_GS_c_o)
    assign REG_GS_o = REG_GS_c_o;
    ...
    wire [63:0] REG_EXPS_a_o, REG_EXPS_b_o, REG_EXPS_c_o;
    ...
    `REG_RST_WE(REG_EXPS_c, 64, clk, rst, we_EXPS, din_EXPS, REG_EXPS_c_o)
    assign REG_EXPS_o = REG_EXPS_c_o;
    ...
    wire [63:0] REG_EBX_a_o, REG_EBX_b_o, REG_EBX_c_o;
    `REG_RST_WE(REG_EBX_a, 64, clk, rst, we_EBX, din_EBX, REG_EBX_a_o)
    `REG_RST_WE(REG_EBX_b, 64, clk, rst, we_EBX, din_EBX, REG_EBX_b_o)
    `REG_RST_WE(REG_EBX_c, 64, clk, rst, we_EBX, din_EBX, REG_EBX_c_o)
    assign REG_EBX_o = REG_EBX_c_o;
    ...
    wire [63:0] REG_ECX_a_o, REG_ECX_b_o, REG_ECX_c_o;
    `REG_RST_WE(REG_ECX_a, 64, clk, rst, we_ECX, din_ECX, REG_ECX_a_o)
    `REG_RST_WE(REG_ECX_b, 64, clk, rst, we_ECX, din_ECX, REG_ECX_b_o)
    `REG_RST_WE(REG_ECX_c, 64, clk, rst, we_ECX, din_ECX, REG_ECX_c_o)
    assign REG_ECX_o = REG_ECX_c_o;
    ...
    wire [63:0] REG_EDX_a_o, REG_EDX_b_o, REG_EDX_c_o;
    `REG_RST_WE(REG_EDX_a, 64, clk, rst, we_EDX, din_EDX, REG_EDX_a_o)
    `REG_RST_WE(REG_EDX_b, 64, clk, rst, we_EDX, din_EDX, REG_EDX_b_o)
    `REG_RST_WE(REG_EDX_c, 64, clk, rst, we_EDX, din_EDX, REG_EDX_c_o)
    assign REG_EDX_o = REG_EDX_c_o;
    ...
    wire [63:0] REG_ESI_a_o, REG_ESI_b_o, REG_ESI_c_o;
    `REG_RST_WE(REG_ESI_a, 64, clk, rst, we_ESI, din_ESI, REG_ESI_a_o)
    `REG_RST_WE(REG_ESI_b, 64, clk, rst, we_ESI, din_ESI, REG_ESI_b_o)
    `REG_RST_WE(REG_ESI_c, 64, clk, rst, we_ESI, din_ESI, REG_ESI_c_o)
    assign REG_ESI_o = REG_ESI_c_o;
    ...
    wire [63:0] REG_EDI_a_o, REG_EDI_b_o, REG_EDI_c_o;
    `REG_RST_WE(REG_EDI_a, 64, clk, rst, we_EDI, din_EDI, REG_EDI_a_o)
    `REG_RST_WE(REG_EDI_b, 64, clk, rst, we_EDI, din_EDI, REG_EDI_b_o)
    `REG_RST_WE(REG_EDI_c, 64, clk, rst, we_EDI, din_EDI, REG_EDI_c_o)
    assign REG_EDI_o = REG_EDI_c_o;
    ...
    wire [63:0] REG_ESP_a_o, REG_ESP_b_o, REG_ESP_c_o;
    `REG_RST_WE(REG_ESP_a, 64, clk, rst, we_ESP, din_ESP, REG_ESP_a_o)
    `REG_RST_WE(REG_ESP_b, 64, clk, rst, we_ESP, din_ESP, REG_ESP_b_o)
    `REG_RST_WE(REG_ESP_c, 64, clk, rst, we_ESP, din_ESP, REG_ESP_c_o)
    assign REG_ESP_o = REG_ESP_c_o;
    ...
    wire [63:0] REG_EBP_a_o, REG_EBP_b_o, REG_EBP_c_o;
    `REG_RST_WE(REG_EBP_a, 64, clk, rst, we_EBP, din_EBP, REG_EBP_a_o)
    `REG_RST_WE(REG_EBP_b, 64, clk, rst, we_EBP, din_EBP, REG_EBP_b_o)
    `REG_RST_WE(REG_EBP_c, 64, clk, rst, we_EBP, din_EBP, REG_EBP_c_o)
    assign REG_EBP_o = REG_EBP_c_o;
    ...
    wire [63:0] REG_MM0_a_o, REG_MM0_b_o, REG_MM0_c_o;
    `REG_RST_WE(REG_MM0_a, 64, clk, rst, we_MM0, din_MM0, REG_MM0_a_o)
    `REG_RST_WE(REG_MM0_b, 64, clk, rst, we_MM0, din_MM0, REG_MM0_b_o)
    `REG_RST_WE(REG_MM0_c, 64, clk, rst, we_MM0, din_MM0, REG_MM0_c_o)
    assign REG_MM0_o = REG_MM0_c_o;
    ...
    wire [63:0] REG_MM1_a_o, REG_MM1_b_o, REG_MM1_c_o;
    `REG_RST_WE(REG_MM1_a, 64, clk, rst, we_MM1, din_MM1, REG_MM1_a_o)
    `REG_RST_WE(REG_MM1_b, 64, clk, rst, we_MM1, din_MM1, REG_MM1_b_o)
    `REG_RST_WE(REG_MM1_c, 64, clk, rst, we_MM1, din_MM1, REG_MM1_c_o)
    assign REG_MM1_o = REG_MM1_c_o;
    ...
    wire [63:0] REG_MM2_a_o, REG_MM2_b_o, REG_MM2_c_o;
    `REG_RST_WE(REG_MM2_a, 64, clk, rst, we_MM2, din_MM2, REG_MM2_a_o)
    `REG_RST_WE(REG_MM2_b, 64, clk, rst, we_MM2, din_MM2, REG_MM2_b_o)
    `REG_RST_WE(REG_MM2_c, 64, clk, rst, we_MM2, din_MM2, REG_MM2_c_o)
    assign REG_MM2_o = REG_MM2_c_o;
    ...
    wire [63:0] REG_MM3_a_o, REG_MM3_b_o, REG_MM3_c_o;
    `REG_RST_WE(REG_MM3_a, 64, clk, rst, we_MM3, din_MM3, REG_MM3_a_o)
    `REG_RST_WE(REG_MM3_b, 64, clk, rst, we_MM3, din_MM3, REG_MM3_b_o)
    `REG_RST_WE(REG_MM3_c, 64, clk, rst, we_MM3, din_MM3, REG_MM3_c_o)
    assign REG_MM3_o = REG_MM3_c_o;
    ...
    wire [63:0] REG_MM4_a_o, REG_MM4_b_o, REG_MM4_c_o;
    `REG_RST_WE(REG_MM4_a, 64, clk, rst, we_MM4, din_MM4, REG_MM4_a_o)
    `REG_RST_WE(REG_MM4_b, 64, clk, rst, we_MM4, din_MM4, REG_MM4_b_o)
    `REG_RST_WE(REG_MM4_c, 64, clk, rst, we_MM4, din_MM4, REG_MM4_c_o)
    assign REG_MM4_o = REG_MM4_c_o;
    ...
    wire [63:0] REG_MM5_a_o, REG_MM5_b_o, REG_MM5_c_o;
    `REG_RST_WE(REG_MM5_a, 64, clk, rst, we_MM5, din_MM5, REG_MM5_a_o)
    `REG_RST_WE(REG_MM5_b, 64, clk, rst, we_MM5, din_MM5, REG_MM5_b_o)
    `REG_RST_WE(REG_MM5_c, 64, clk, rst, we_MM5, din_MM5, REG_MM5_c_o)
    assign REG_MM5_o = REG_MM5_c_o;
    ...
    wire [63:0] REG_MM6_a_o, REG_MM6_b_o, REG_MM6_c_o;
    `REG_RST_WE(REG_MM6_a, 64, clk, rst, we_MM6, din_MM6, REG_MM6_a_o)
    `REG_RST_WE(REG_MM6_b, 64, clk, rst, we_MM6, din_MM6, REG_MM6_b_o)
    `REG_RST_WE(REG_MM6_c, 64, clk, rst, we_MM6, din_MM6, REG_MM6_c_o)
    assign REG_MM6_o = REG_MM6_c_o;
    ...
    wire [63:0] REG_MM7_a_o, REG_MM7_b_o, REG_MM7_c_o;
    `REG_RST_WE(REG_MM7_a, 64, clk, rst, we_MM7, din_MM7, REG_MM7_a_o)
    `REG_RST_WE(REG_MM7_b, 64, clk, rst, we_MM7, din_MM7, REG_MM7_b_o)
    `REG_RST_WE(REG_MM7_c, 64, clk, rst, we_MM7, din_MM7, REG_MM7_c_o)
    assign REG_MM7_o = REG_MM7_c_o;
    ...
    wire [63:0] REG_ETR_a_o, REG_ETR_b_o, REG_ETR_c_o;
    `REG_RST_WE(REG_ETR_a, 64, clk, rst, we_ETR, din_ETR, REG_ETR_a_o)
    `REG_RST_WE(REG_ETR_b, 64, clk, rst, we_ETR, din_ETR, REG_ETR_b_o)
    `REG_RST_WE(REG_ETR_c, 64, clk, rst, we_ETR, din_ETR, REG_ETR_c_o)
    assign REG_ETR_o = REG_ETR_c_o;
    ...
    wire [63:0] REG_ERROR_REG_a_o, REG_ERROR_REG_b_o, REG_ERROR_REG_c_o;
    ...
    `REG_RST_WE(REG_ERROR_REG_c, 64, clk, rst, we_ERROR_REG, din_ERROR_REG, REG_ERROR_REG_c_o)
    assign REG_ERROR_REG_o = REG_ERROR_REG_c_o;
    ...
    wire [63:0] REG_NO_REG_a_o, REG_NO_REG_b_o, REG_NO_REG_c_o;
    ...
    `REG_RST_WE(REG_NO_REG_c, 64, clk, rst, we_NO_REG, din_NO_REG, REG_NO_REG_c_o)
    assign REG_NO_REG_o = REG_NO_REG_c_o;
    ...
    // CS_data bit 14 is buffered: REG_CS_b.Q[14] would otherwise drive 3 segment
