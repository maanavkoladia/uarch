    ...
    // =========================================================================
    // RR_Latches output wires (latched values consumed by RR module)
    // =========================================================================
    `define RR_LATCHES
    ...
    wire [31:0] rr_latches_normal_exe_cs_OP_TYPE;
    wire [31:0] rr_latches_normal_exe_cs_alu_inputA_sel;
    wire [31:0] rr_latches_normal_exe_cs_alu_inputB_sel;
    wire [31:0] rr_latches_normal_exe_cs_branch_target_sel;
    ...
    wire [31:0] rr_latches_rep_exe_cs_OP_TYPE;
    wire [31:0] rr_latches_rep_exe_cs_alu_inputA_sel;
    wire [31:0] rr_latches_rep_exe_cs_alu_inputB_sel;
    wire [31:0] rr_latches_rep_exe_cs_branch_target_sel;
    ...
    RR_Latches rr_latches_unit (
        ...
        // ---- nextLatches.normal_* (driven by Decode) ----
        ...
        // ---- nextLatches.rep_* (driven by Decode) ----
        ...
        // ---- latches_o.normal_* (latched outputs consumed by RR) ----
        ...
        // ---- latches_o.rep_* (latched outputs consumed by RR) ----
