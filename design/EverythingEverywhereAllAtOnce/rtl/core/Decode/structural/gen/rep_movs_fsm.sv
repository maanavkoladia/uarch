...
// NS_1 = (S_0 & !S_2 & !stall_i) | (!S_0 & S_1 & S_2) | (S_1 & !S_2 & stall_i) | (!S_0 & S_2 & !cont_mov_i & !wait_mov_i & !exit_mov_i & !stall_i)
wire NS_1_t0;
...
// NS_2 = (!S_0 & S_2 & cont_mov_i) | (!S_1 & S_2 & stall_i) | (!S_0 & S_1 & !stall_i) | (!S_0 & S_1 & S_2) | (!S_0 & !S_2 & start_i & !stall_i) | (!S_0 & S_2 & wait_mov_i)
wire NS_2_t0;
`AND_3(NS_2_and0, 1, NS_2_t0, S_0_inv, S_2, cont_mov_i)
wire NS_2_t1;
...
wire NS_2_t5;
`AND_3(NS_2_and5, 1, NS_2_t5, S_0_inv, S_2, wait_mov_i)
