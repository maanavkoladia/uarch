...
wire NS_0_t1;
`AND_3(NS_0_and1, 1, NS_0_t1, S_0, S_1, S_2_inv)
wire NS_0_t2;
...
// NS_2 = (!S_0 & S_1 & !stall_i) | (!S_1 & S_2 & stall_i) | (!S_0 & S_2 & stall_i) | (!S_0 & S_2 & wait_mov_i) | (!S_0 & !S_2 & start_i & !stall_i) | (!S_0 & S_2 & cont_mov_i)
wire NS_2_t0;
