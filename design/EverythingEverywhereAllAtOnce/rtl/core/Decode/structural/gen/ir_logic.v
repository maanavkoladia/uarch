...
// o1_5_o = (i5_i & !i2_i) | (i5_i & !i0_i) | (i5_i & !i1_i) | (i5_i & !i3_i) | (i5_i & !i4_i) | (!i5_i & i4_i & i3_i & i2_i & i1_i & i0_i)
wire o1_5_o_t0;
wire o1_5_o_t1;
wire o1_5_o_t2;
wire o1_5_o_t3;
...
and2$ o1_5_o_and3 (o1_5_o_t3, i5_i, i3_i_inv);
...
// o1_4_o = (i4_i & !i3_i) | (i4_i & !i1_i) | (i4_i & !i2_i) | (i4_i & !i0_i) | (!i4_i & i3_i & i2_i & i1_i & i0_i)
wire o1_4_o_t0;
wire o1_4_o_t1;
wire o1_4_o_t2;
wire o1_4_o_t3;
...
// o1_3_o = (i3_i & !i2_i) | (i3_i & !i0_i) | (i3_i & !i1_i) | (!i3_i & i2_i & i1_i & i0_i)
wire o1_3_o_t0;
wire o1_3_o_t1;
wire o1_3_o_t2;
wire o1_3_o_t3;
...
and2$ o1_3_o_and1 (o1_3_o_t1, i3_i, i0_i_inv);
...
// o2_5_o = (i5_i & !i2_i) | (i5_i & !i1_i) | (i5_i & !i3_i) | (i5_i & !i4_i) | (!i5_i & i4_i & i3_i & i2_i & i1_i)
wire o2_5_o_t0;
wire o2_5_o_t1;
wire o2_5_o_t2;
wire o2_5_o_t3;
...
and2$ o2_5_o_and2 (o2_5_o_t2, i5_i, i3_i_inv);
...
// o3_5_o = (i5_i & !i2_i) | (i5_i & !i3_i) | (i5_i & !i4_i) | (!i5_i & i4_i & i3_i & i2_i & i1_i) | (i5_i & !i1_i & !i0_i) | (!i5_i & i4_i & i3_i & i2_i & i0_i)
wire o3_5_o_t0;
wire o3_5_o_t1;
wire o3_5_o_t2;
wire o3_5_o_t3;
...
and2$ o7_3_o_and2 (o7_3_o_t2, i3_i_inv, i2_i);
...
// o9_5_o = (i5_i & !i4_i) | (!i5_i & i4_i & i3_i) | (i5_i & !i3_i & !i1_i) | (i5_i & !i3_i & !i0_i) | (i5_i & !i3_i & !i2_i) | (!i5_i & i4_i & i2_i & i1_i & i0_i)
wire o9_5_o_t0;
wire o9_5_o_t1;
wire o9_5_o_t2;
wire o9_5_o_t3;
...
and3$ o9_5_o_and4 (o9_5_o_t4, i5_i, i3_i_inv, i2_i_inv);
...
and3$ o12_5_o_and1 (o12_5_o_t1, i5_i_inv, i4_i, i3_i);
and3$ o12_5_o_and2 (o12_5_o_t2, i5_i_inv, i4_i, i2_i);
...
// o13_5_o = (i5_i & !i4_i) | (!i5_i & i4_i & i2_i) | (!i5_i & i4_i & i3_i) | (i5_i & !i3_i & !i2_i & !i0_i) | (i5_i & !i3_i & !i2_i & !i1_i) | (!i5_i & i4_i & i1_i & i0_i)
wire o13_5_o_t0;
wire o13_5_o_t1;
wire o13_5_o_t2;
wire o13_5_o_t3;
...
// o13_4_o = (!i4_i & i3_i) | (!i4_i & i2_i) | (i4_i & !i3_i & !i2_i & !i1_i) | (!i4_i & i1_i & i0_i) | (i4_i & !i3_i & !i2_i & !i0_i)
wire o13_4_o_t0;
wire o13_4_o_t1;
wire o13_4_o_t2;
wire o13_4_o_t3;
...
// o14_5_o = (i5_i & !i4_i) | (!i5_i & i4_i & i1_i) | (!i5_i & i4_i & i2_i) | (!i5_i & i4_i & i3_i) | (i5_i & !i3_i & !i2_i & !i1_i)
wire o14_5_o_t0;
wire o14_5_o_t1;
wire o14_5_o_t2;
wire o14_5_o_t3;
...
and3$ o14_5_o_and1 (o14_5_o_t1, i5_i_inv, i4_i, i1_i);
and3$ o14_5_o_and2 (o14_5_o_t2, i5_i_inv, i4_i, i2_i);
...
// o14_4_o = (!i4_i & i3_i) | (!i4_i & i1_i) | (!i4_i & i2_i) | (i4_i & !i3_i & !i2_i & !i1_i)
wire o14_4_o_t0;
wire o14_4_o_t1;
wire o14_4_o_t2;
wire o14_4_o_t3;

and2$ o14_4_o_and0 (o14_4_o_t0, i4_i_inv, i3_i);
and2$ o14_4_o_and1 (o14_4_o_t1, i4_i_inv, i1_i);
and2$ o14_4_o_and2 (o14_4_o_t2, i4_i_inv, i2_i);
...
// o15_5_o = (i5_i & !i4_i) | (!i5_i & i4_i & i1_i) | (!i5_i & i4_i & i0_i) | (!i5_i & i4_i & i2_i) | (!i5_i & i4_i & i3_i) | (i5_i & !i3_i & !i2_i & !i1_i & !i0_i)
wire o15_5_o_t0;
wire o15_5_o_t1;
wire o15_5_o_t2;
wire o15_5_o_t3;
...
and3$ o15_5_o_and1 (o15_5_o_t1, i5_i_inv, i4_i, i1_i);
and3$ o15_5_o_and2 (o15_5_o_t2, i5_i_inv, i4_i, i0_i);
and3$ o15_5_o_and3 (o15_5_o_t3, i5_i_inv, i4_i, i2_i);
...
and2$ o15_4_o_and0 (o15_4_o_t0, i4_i_inv, i1_i);
and2$ o15_4_o_and1 (o15_4_o_t1, i4_i_inv, i3_i);
and2$ o15_4_o_and2 (o15_4_o_t2, i4_i_inv, i0_i);
and2$ o15_4_o_and3 (o15_4_o_t3, i4_i_inv, i2_i);
