...
// o1_5_o = (i5_i & !i1_i) | (i5_i & !i2_i) | (i5_i & !i3_i) | (i5_i & !i0_i) | (i5_i & !i4_i) | (!i5_i & i4_i & i3_i & i2_i & i1_i & i0_i)
wire o1_5_o_t0;
wire o1_5_o_t1;
wire o1_5_o_t2;
wire o1_5_o_t3;
...
and2$ o1_5_o_and0 (o1_5_o_t0, i5_i, i1_i_inv);
and2$ o1_5_o_and1 (o1_5_o_t1, i5_i, i2_i_inv);
and2$ o1_5_o_and2 (o1_5_o_t2, i5_i, i3_i_inv);
and2$ o1_5_o_and3 (o1_5_o_t3, i5_i, i0_i_inv);
...
// o2_5_o = (i5_i & !i1_i) | (i5_i & !i2_i) | (i5_i & !i3_i) | (i5_i & !i4_i) | (!i5_i & i4_i & i3_i & i2_i & i1_i)
wire o2_5_o_t0;
wire o2_5_o_t1;
wire o2_5_o_t2;
wire o2_5_o_t3;
...
and2$ o2_5_o_and0 (o2_5_o_t0, i5_i, i1_i_inv);
and2$ o2_5_o_and1 (o2_5_o_t1, i5_i, i2_i_inv);
...
// o4_5_o = (i5_i & !i3_i) | (i5_i & !i4_i) | (i5_i & !i2_i) | (!i5_i & i4_i & i3_i & i2_i)
wire o4_5_o_t0;
wire o4_5_o_t1;
wire o4_5_o_t2;
wire o4_5_o_t3;
...
// o7_5_o = (i5_i & !i3_i) | (i5_i & !i4_i) | (!i5_i & i4_i & i3_i & i2_i) | (!i5_i & i4_i & i3_i & i1_i) | (!i5_i & i4_i & i3_i & i0_i) | (i5_i & !i2_i & !i1_i & !i0_i)
wire o7_5_o_t0;
wire o7_5_o_t1;
wire o7_5_o_t2;
wire o7_5_o_t3;
...
// o7_3_o = (!i3_i & i2_i) | (!i3_i & i0_i) | (!i3_i & i1_i) | (i3_i & !i2_i & !i1_i & !i0_i)
wire o7_3_o_t0;
wire o7_3_o_t1;
wire o7_3_o_t2;
wire o7_3_o_t3;
...
and2$ o7_3_o_and1 (o7_3_o_t1, i3_i_inv, i0_i);
...
// o15_5_o = (i5_i & !i4_i) | (!i5_i & i4_i & i3_i) | (!i5_i & i4_i & i0_i) | (!i5_i & i4_i & i1_i) | (!i5_i & i4_i & i2_i) | (i5_i & !i3_i & !i2_i & !i1_i & !i0_i)
wire o15_5_o_t0;
wire o15_5_o_t1;
wire o15_5_o_t2;
wire o15_5_o_t3;
...
// o15_4_o = (!i4_i & i2_i) | (!i4_i & i1_i) | (!i4_i & i0_i) | (!i4_i & i3_i) | (i4_i & !i3_i & !i2_i & !i1_i & !i0_i)
wire o15_4_o_t0;
wire o15_4_o_t1;
wire o15_4_o_t2;
wire o15_4_o_t3;
...
// o15_3_o = (i3_i & i1_i) | (i3_i & i2_i) | (i3_i & i0_i) | (!i3_i & !i2_i & !i1_i & !i0_i)
wire o15_3_o_t0;
wire o15_3_o_t1;
wire o15_3_o_t2;
wire o15_3_o_t3;
