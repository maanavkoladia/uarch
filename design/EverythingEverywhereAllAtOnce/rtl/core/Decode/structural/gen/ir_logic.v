...
// o1_5_o = (i5_i & !i1_i) | (i5_i & !i2_i) | (i5_i & !i4_i) | (i5_i & !i3_i) | (i5_i & !i0_i) | (!i5_i & i4_i & i3_i & i2_i & i1_i & i0_i)
wire o1_5_o_t0;
wire o1_5_o_t1;
wire o1_5_o_t2;
wire o1_5_o_t3;
...
and2$ o1_5_o_and2 (o1_5_o_t2, i5_i, i4_i_inv);
...
// o1_4_o = (i4_i & !i0_i) | (i4_i & !i1_i) | (i4_i & !i3_i) | (i4_i & !i2_i) | (!i4_i & i3_i & i2_i & i1_i & i0_i)
wire o1_4_o_t0;
wire o1_4_o_t1;
wire o1_4_o_t2;
wire o1_4_o_t3;
...
and2$ o1_4_o_and3 (o1_4_o_t3, i4_i, i2_i_inv);
...
// o2_4_o = (i4_i & !i1_i) | (i4_i & !i2_i) | (i4_i & !i3_i) | (!i4_i & i3_i & i2_i & i1_i)
wire o2_4_o_t0;
wire o2_4_o_t1;
wire o2_4_o_t2;
wire o2_4_o_t3;
...
// o14_5_o = (i5_i & !i4_i) | (!i5_i & i4_i & i2_i) | (!i5_i & i4_i & i3_i) | (!i5_i & i4_i & i1_i) | (i5_i & !i3_i & !i2_i & !i1_i)
wire o14_5_o_t0;
wire o14_5_o_t1;
wire o14_5_o_t2;
wire o14_5_o_t3;
...
and3$ o14_5_o_and2 (o14_5_o_t2, i5_i_inv, i4_i, i3_i);
...
// o14_4_o = (!i4_i & i1_i) | (!i4_i & i3_i) | (!i4_i & i2_i) | (i4_i & !i3_i & !i2_i & !i1_i)
wire o14_4_o_t0;
wire o14_4_o_t1;
wire o14_4_o_t2;
wire o14_4_o_t3;
...
// o15_5_o = (i5_i & !i4_i) | (!i5_i & i4_i & i2_i) | (!i5_i & i4_i & i3_i) | (!i5_i & i4_i & i1_i) | (!i5_i & i4_i & i0_i) | (i5_i & !i3_i & !i2_i & !i1_i & !i0_i)
wire o15_5_o_t0;
wire o15_5_o_t1;
wire o15_5_o_t2;
wire o15_5_o_t3;
...
and3$ o15_5_o_and4 (o15_5_o_t4, i5_i_inv, i4_i, i0_i);
