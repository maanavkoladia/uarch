...
// NS_1 = (S_1 & !S_2) | (S_1 & wait_i) | (S_0 & S_1) | (S_0 & !S_2 & wait_i) | (S_0 & !S_2 & !exit_mov_i) | (S_0 & S_2 & cont_cmp_i & !wait_i) | (S_0 & S_2 & !exit_cmp_i & !wait_i)
wire NS_1_t0;
`AND_2(NS_1_and0, 1, NS_1_t0, S_1, S_2_inv)
wire NS_1_t1;
`AND_2(NS_1_and1, 1, NS_1_t1, S_1, wait_i)
wire NS_1_t2;
`AND_2(NS_1_and2, 1, NS_1_t2, S_0, S_1)
wire NS_1_t3;
