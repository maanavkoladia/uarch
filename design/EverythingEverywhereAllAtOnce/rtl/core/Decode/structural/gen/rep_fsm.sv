...
// NS_0 = (S_0 & !S_3 & stall_i) | (S_0 & !S_1 & stall_i) | (!S_0 & !S_2 & S_3 & !stall_i) | (S_1 & S_2 & !S_3 & !stall_i) | (!S_0 & !S_3 & rep_prefix_i & !stall_i) | (S_0 & !S_2 & stall_i) | (!S_0 & S_2 & !S_3 & !stall_i) | (!S_0 & S_1 & !S_3 & !stall_i) | (S_0 & !S_1 & S_2 & S_3 & cs_cmp_i) | (S_0 & !S_1 & S_2 & S_3 & !cs_mov_i)
wire NS_0_t0;
wire NS_0_t1;
wire NS_0_t2;
wire NS_0_t3;
...
and4$ NS_0_and7 (NS_0_t7, S_0_inv, S_1, S_3_inv, stall_i_inv);
...
// select_line0_o = (S_0 & !S_1 & !S_2 & S_3 & !stall_i) | (!S_0 & !S_1 & S_2 & !S_3 & !stall_i) | (S_0 & S_1 & !S_2 & !S_3 & !stall_i) | (S_0 & !S_2 & !S_3 & cont_cmp_i & !stall_i) | (!S_0 & !S_1 & S_2 & cont_mov_i & !stall_i)
...
and5$ select_line0_o_and1 (select_line0_o_t1, S_0_inv, S_1_inv, S_2, S_3_inv, stall_i_inv);
and5$ select_line0_o_and2 (select_line0_o_t2, S_0, S_1, S_2_inv, S_3_inv, stall_i_inv);
and5$ select_line0_o_and3 (select_line0_o_t3, S_0, S_2_inv, S_3_inv, cont_cmp_i, stall_i_inv);
