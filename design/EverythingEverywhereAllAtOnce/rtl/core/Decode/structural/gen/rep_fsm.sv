...
// NS_0 = (S_0 & !S_1 & stall_i) | (S_0 & !S_3 & stall_i) | (!S_0 & !S_2 & rep_prefix_i & !stall_i) | (!S_0 & S_2 & !S_3 & !stall_i) | (S_0 & !S_2 & stall_i) | (S_1 & S_2 & !S_3 & !stall_i) | (!S_0 & !S_2 & S_3 & !stall_i) | (!S_0 & S_1 & !S_2 & !stall_i) | (S_0 & !S_1 & S_2 & S_3 & cs_cmp_i) | (S_0 & !S_1 & S_2 & S_3 & !cs_mov_i)
wire NS_0_t0;
wire NS_0_t1;
wire NS_0_t2;
wire NS_0_t3;
...
and4$ NS_0_and2 (NS_0_t2, S_0_inv, S_2_inv, rep_prefix_i, stall_i_inv);
...
and4$ NS_0_and7 (NS_0_t7, S_0_inv, S_1, S_2_inv, stall_i_inv);
...
and6$ NS_1_and7 (NS_1_t7, S_0, S_1_inv, S_3, cs_mov_i, cs_cmp_i, stall_i_inv);
