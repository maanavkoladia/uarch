...
// NS_0 = (S_0 & !S_3 & stall_i) | (S_0 & !S_1 & stall_i) | (!S_0 & !S_2 & S_3 & !stall_i) | (!S_0 & S_1 & !S_3 & !stall_i) | (S_0 & !S_2 & stall_i) | (!S_0 & S_2 & !S_3 & !stall_i) | (S_1 & S_2 & !S_3 & !stall_i) | (!S_0 & !S_3 & rep_prefix_i & !stall_i) | (S_0 & !S_1 & S_2 & S_3 & !cs_mov_i) | (S_0 & !S_1 & S_2 & S_3 & cs_cmp_i)
wire NS_0_t0;
wire NS_0_t1;
wire NS_0_t2;
wire NS_0_t3;
