...
// NS_0 = (S_0 & !S_1 & stall_i) | (S_0 & !S_2 & stall_i) | (!S_0 & S_1 & !S_3 & !stall_i) | (S_0 & S_1 & S_2 & !S_3) | (!S_0 & !S_2 & S_3 & !stall_i) | (!S_0 & !S_3 & rep_prefix_i & !stall_i) | (!S_0 & S_2 & !S_3 & !stall_i) | (S_0 & !S_1 & S_2 & S_3 & cs_cmp_i) | (S_0 & !S_1 & S_2 & S_3 & !cs_mov_i)
wire NS_0_t0;
wire NS_0_t1;
wire NS_0_t2;
wire NS_0_t3;
...
and4$ NS_0_and5 (NS_0_t5, S_0_inv, S_3_inv, rep_prefix_i, stall_i_inv);
