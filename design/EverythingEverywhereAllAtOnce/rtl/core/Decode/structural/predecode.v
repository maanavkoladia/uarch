module predecode(
    ...
    ppu pfs0(.opcode_index(4'd0), .mod_index(4'd1), .IR(IR), .IR_valid_vect(IR_valid_vect),
        ...
        .imm_size(ppu_imm_size[0]), .disp_size(), .sib_size(), .needrm(ppu_needrm[0]), .sib_byte(ppu_sib_byte[0]), .disp(ppu_displacement[0]), .imm64(ppu_imm[0]),
    ...
    ppu pfs1(.opcode_index(4'd1), .mod_index(4'd2), .IR(IR), .IR_valid_vect(IR_valid_vect),
        ...
        .imm_size(ppu_imm_size[1]), .disp_size(), .sib_size(), .needrm(ppu_needrm[1]), .sib_byte(ppu_sib_byte[1]), .disp(ppu_displacement[1]), .imm64(ppu_imm[1]),
    ...
    ppu pfs2(.opcode_index(4'd2), .mod_index(4'd3), .IR(IR), .IR_valid_vect(IR_valid_vect),
        ...
        .imm_size(ppu_imm_size[2]), .disp_size(), .sib_size(), .needrm(ppu_needrm[2]), .sib_byte(ppu_sib_byte[2]), .disp(ppu_displacement[2]), .imm64(ppu_imm[2]),
    ...
    ppu pfs3(.opcode_index(4'd3), .mod_index(4'd4), .IR(IR), .IR_valid_vect(IR_valid_vect),
        ...
        .imm_size(ppu_imm_size[3]), .disp_size(), .sib_size(), .needrm(ppu_needrm[3]), .sib_byte(ppu_sib_byte[3]), .disp(ppu_displacement[3]), .imm64(ppu_imm[3]),
