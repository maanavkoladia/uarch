module Decode (
    ...
    // ====================================================================
    output wire        outs_o_valid,
    output wire        outs_o_stall,
    output wire [31:0] outs_o_eip,
    output wire        outs_o_invalid_instruction,
    output wire        outs_o_decode_gp,
    output wire        outs_o_rr_stage_latch_we,
    output wire        outs_o_rep_latch,
    output wire        outs_o_decode_forward
);
    ...
    `MUX_4 (u_current_idm_valid, 1, current_idm_slots_valid, idm_outs_idm_slots_0_valid, idm_outs_idm_slots_1_valid, idm_outs_idm_slots_2_valid, idm_outs_idm_slots_3_valid, EIP[5:4])
    ...
    `AND_3(predicted_taken_gate, 1, predicted_taken, current_idm_slots_br_valid, current_idm_slots_br_valid, br_eip_eq_EIP)
    ...
    assign outs_o_valid               = invalid_instruction_not;
    assign outs_o_stall               = invalid_inst;
    assign outs_o_eip                 = EIP;
    assign outs_o_invalid_instruction = invalid_inst;
    assign outs_o_decode_gp           = decode_gp_out;
    assign outs_o_rr_stage_latch_we   = rr_latch_we_o;
    assign outs_o_rep_latch           = REP_LATCH;
    assign outs_o_decode_forward      = decode_forward;
