// Pure Verilog 2005 port of VCache.
// Reference: rtl/DCache/structural/VCache.sv
// Top-level shell: instantiates VCache_FSM (lives in gen/), VCache_TagStore,
// VCache_DataStore. Holds the vcache_swapBuf register set, savedReq snapshot,
// and the addrOut output reconstruction.
...
module VCache (
    ...
    assign useSavedIDX = useSavedReq;
