...
// NS_0 = (S_0 & !S_1 & !S_2) | (!S_1 & !S_2 & V_Hit_i) | (!S_0 & S_1 & !S_2 & !EB_V_i) | (!S_0 & !S_2 & DC_will_evict_i & !EB_V_i)
wire NS_0_t0;
`AND_3(NS_0_and0, 1, NS_0_t0, S_0, S_1_inv, S_2_inv)
wire NS_0_t1;
`AND_3(NS_0_and1, 1, NS_0_t1, S_1_inv, S_2_inv, V_Hit_i)
wire NS_0_t2;
...
wire NS_1_t2;
`AND_4(NS_1_and2, 1, NS_1_t2, S_0_inv, S_2_inv, V_Hit_i, we_i_inv)
wire NS_1_t3;
<<<<<<< HEAD
`AND_5(NS_1_and3, 1, NS_1_t3, S_1_inv, S_2_inv, V_Hit_i_inv, DC_will_evict_i, VC_needs_2_evict_i)
wire NS_1_t4;
`AND_5(NS_1_and4, 1, NS_1_t4, S_1_inv, S_2_inv, V_Hit_i_inv, DC_will_evict_i, EB_V_i_inv)
=======
`AND_5(NS_1_and3, 1, NS_1_t3, S_0_inv, S_2_inv, V_Hit_i_inv, DC_will_evict_i, VC_needs_2_evict_i)
wire NS_1_t4;
`AND_5(NS_1_and4, 1, NS_1_t4, S_0_inv, S_2_inv, V_Hit_i_inv, DC_will_evict_i, EB_V_i_inv)
>>>>>>> 4383dffba64038f1eb36da43b2728440433db209
...
`AND_3(Write_VSWAP_o_and0, 1, Write_VSWAP_o_t0, S_0, S_1_inv, S_2_inv)
wire Write_VSWAP_o_t1;
`AND_4(Write_VSWAP_o_and1, 1, Write_VSWAP_o_t1, S_1_inv, S_2_inv, V_Hit_i, we_i_inv)

`OR_2(Write_VSWAP_o_or, 1, Write_VSWAP_o, Write_VSWAP_o_t0, Write_VSWAP_o_t1)
