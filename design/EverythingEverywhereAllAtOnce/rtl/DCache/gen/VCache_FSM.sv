...
and3$ NS_0_and0 (NS_0_t0, S_0, S_1_inv, S_2_inv);
...
and5$ NS_1_and3 (NS_1_t3, S_1_inv, S_2_inv, V_Hit_i_inv, DC_will_evict_i, EB_V_i_inv);
and5$ NS_1_and4 (NS_1_t4, S_1_inv, S_2_inv, V_Hit_i_inv, DC_will_evict_i, VC_needs_2_evict_i);
